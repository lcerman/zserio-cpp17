...
<#if isPackable && usedInPackedArray>
    ...
    static void write(PackingContext& packingContext, BitStreamWriter& writer,
...
<#if containsOffset>
    ...
    <#if isPackable && usedInPackedArray>
    static BitSize initializeOffsets(PackingConext& packingContext, const View<${fullName}>& view,
            BitSize bitPosition);
    </#if>
</#if>
};
