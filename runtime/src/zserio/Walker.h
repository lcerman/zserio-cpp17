...
private:
    ...
    bool walkFieldValue(const IBasicReflectableDataConstPtr<ALLOC>& reflectable,
            const BasicFieldInfo<ALLOC>& fieldInfo, ::std::size_t elementIndex = WALKER_NOT_ELEMENT);
...
public:
     ...
     */
    explicit BasicDepthWalkFilter(::std::size_t maxDepth);
    ...
    bool beforeCompound(const IBasicReflectableDataConstPtr<ALLOC>& compound,
            const BasicFieldInfo<ALLOC>& fieldInfo, ::std::size_t elementIndex) override;
    ...
    bool beforeValue(const IBasicReflectableDataConstPtr<ALLOC>& value, const BasicFieldInfo<ALLOC>& fieldInfo,
            ::std::size_t elementIndex) override;
...
private:
    ...
    void appendPath(const BasicFieldInfo<ALLOC>& fieldInfo, ::std::size_t elementIndex);
    void popPath(const BasicFieldInfo<ALLOC>& fieldInfo, ::std::size_t elementIndex);
...
public:
     ...
     */
    explicit BasicArrayLengthWalkFilter(::std::size_t maxArrayLength);
...
private:
    bool filterArrayElement(::std::size_t elementIndex);

    ::std::size_t m_maxArrayLength;
};
        ...
        const IBasicReflectableDataConstPtr<ALLOC>& reflectable, const BasicFieldInfo<ALLOC>& fieldInfo)
{
    if (reflectable && fieldInfo.isArray)
    {
        if (m_walkFilter.beforeArray(reflectable, fieldInfo))
        {
            ...
            for (::std::size_t i = 0; i < reflectable->size(); ++i)
            {
...
bool BasicWalker<ALLOC>::walkFieldValue(const IBasicReflectableDataConstPtr<ALLOC>& reflectable,
        const BasicFieldInfo<ALLOC>& fieldInfo, ::std::size_t elementIndex)
{
...
template <typename ALLOC>
BasicDepthWalkFilter<ALLOC>::BasicDepthWalkFilter(::std::size_t maxDepth) :
        m_maxDepth(maxDepth),
        m_depth(1)
{}
...
bool BasicDepthWalkFilter<ALLOC>::beforeCompound(
        const IBasicReflectableDataConstPtr<ALLOC>&, const BasicFieldInfo<ALLOC>&, ::std::size_t)
{
    return enterDepthLevel();
}
...
template <typename ALLOC>
void BasicRegexWalkFilter<ALLOC>::appendPath(const BasicFieldInfo<ALLOC>& fieldInfo, ::std::size_t elementIndex)
{
    detail::appendPathImpl(m_currentPath, fieldInfo, elementIndex, m_allocator);
}

template <typename ALLOC>
void BasicRegexWalkFilter<ALLOC>::popPath(const BasicFieldInfo<ALLOC>& fieldInfo, ::std::size_t elementIndex)
{
    detail::popPathImpl(m_currentPath, fieldInfo, elementIndex, m_allocator);
}
...
template <typename ALLOC>
BasicArrayLengthWalkFilter<ALLOC>::BasicArrayLengthWalkFilter(::std::size_t maxArrayLength) :
...
bool BasicArrayLengthWalkFilter<ALLOC>::beforeCompound(
        const IBasicReflectableDataConstPtr<ALLOC>&, const BasicFieldInfo<ALLOC>&, ::std::size_t elementIndex)
{
...
template <typename ALLOC>
bool BasicArrayLengthWalkFilter<ALLOC>::filterArrayElement(::std::size_t elementIndex)
{
