...
using IService = IBasicService<std::pmr::polymorphic_allocator<::std::uint8_t>>;
using IServiceClient = IBasicServiceClient<std::pmr::polymorphic_allocator<::std::uint8_t>>;
/** \} */
...
using IntrospectableServiceData =
        BasicIntrospectableServiceData<ZSERIO_OBJECT, std::pmr::polymorphic_allocator<::std::uint8_t>>;
using ObjectServiceData = BasicObjectServiceData<std::pmr::polymorphic_allocator<::std::uint8_t>>;
using RawServiceDataHolder = BasicRawServiceDataHolder<std::pmr::polymorphic_allocator<::std::uint8_t>>;
using RawServiceDataView = BasicRawServiceDataView<std::pmr::polymorphic_allocator<::std::uint8_t>>;
