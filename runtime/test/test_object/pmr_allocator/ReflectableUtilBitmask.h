...
#ifndef TEST_OBJECT_PMR_ALLOCATOR_REFLECTABLE_UTIL_BITMASK_H
#define TEST_OBJECT_PMR_ALLOCATOR_REFLECTABLE_UTIL_BITMASK_H
...
template <>
struct TypeInfo<::test_object::pmr_allocator::ReflectableUtilBitmask, ::std::pmr::polymorphic_allocator<::std::uint8_t>>
{
...
template <>
struct hash<::test_object::pmr_allocator::ReflectableUtilBitmask>
{
    ::std::size_t operator()(const ::test_object::pmr_allocator::ReflectableUtilBitmask& value) const;
};

} // namespace std

#endif // TEST_OBJECT_PMR_ALLOCATOR_REFLECTABLE_UTIL_BITMASK_H
