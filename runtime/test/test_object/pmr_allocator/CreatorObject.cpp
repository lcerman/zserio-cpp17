...
View<::test_object::pmr_allocator::CreatorNested> View<::test_object::pmr_allocator::CreatorObject>::ZserioNestedArrayArrayTraits::at(const OwnerType& owner,
        const ::test_object::pmr_allocator::CreatorNested& element, ::std::size_t)
{
...
void View<::test_object::pmr_allocator::CreatorObject>::ZserioNestedArrayArrayTraits::read(BitStreamReader& reader, const OwnerType& owner,
        ::test_object::pmr_allocator::CreatorNested& element, ::std::size_t)
{
...
const ::zserio::pmr::ITypeInfo& TypeInfo<::test_object::pmr_allocator::CreatorObject, ::std::pmr::polymorphic_allocator<::std::uint8_t>>::get()
{
    ...
    static const ::std::array<::zserio::BasicFieldInfo<AllocatorType>, 9> fields = {
        ...
        ::zserio::BasicFieldInfo<AllocatorType>{
            "nested", // schemaName
            ::zserio::typeInfo<::test_object::pmr_allocator::CreatorNested, ::std::pmr::polymorphic_allocator<::std::uint8_t>>(), // typeInfo
        ...
        ::zserio::BasicFieldInfo<AllocatorType>{
            ...
            ::zserio::typeInfo<::zserio::pmr::BitBuffer, ::std::pmr::polymorphic_allocator<::std::uint8_t>>(), // typeInfo
            {}, // typeArguments
            false, // isExtended
            {}, // alignment
            {}, // offset
        ...
        ::zserio::BasicFieldInfo<AllocatorType>{
            ...
            ::zserio::typeInfo<::zserio::pmr::Bytes, ::std::pmr::polymorphic_allocator<::std::uint8_t>>(), // typeInfo
            {}, // typeArguments
            false, // isExtended
            {}, // alignment
            {}, // offset
        ...
        ::zserio::BasicFieldInfo<AllocatorType>{
            ...
            ::zserio::typeInfo<::zserio::Bool, ::std::pmr::polymorphic_allocator<::std::uint8_t>>(), // typeInfo
            {}, // typeArguments
            false, // isExtended
            {}, // alignment
            {}, // offset
...
::zserio::pmr::IReflectableDataConstPtr Reflectable<::test_object::pmr_allocator::CreatorObject, ::std::pmr::polymorphic_allocator<::std::uint8_t>>::create(
        const ::test_object::pmr_allocator::CreatorObject& value, const ::std::pmr::polymorphic_allocator<::std::uint8_t>& allocator)
{
    ...
    public:
        ...
        explicit ReflectableImpl(const ::test_object::pmr_allocator::CreatorObject& object, const ::std::pmr::polymorphic_allocator<::std::uint8_t>& alloc = {}) :
                ::zserio::detail::ReflectableDataConstAllocatorHolderBase<::std::pmr::polymorphic_allocator<::std::uint8_t>>(typeInfo<::test_object::pmr_allocator::CreatorObject>(), alloc),
                m_object(object)
        {}
...
::zserio::pmr::IReflectableDataPtr Reflectable<::test_object::pmr_allocator::CreatorObject, ::std::pmr::polymorphic_allocator<::std::uint8_t>>::create(
        ::test_object::pmr_allocator::CreatorObject& value, const ::std::pmr::polymorphic_allocator<::std::uint8_t>& allocator)
{
    ...
    public:
        ...
        explicit ReflectableImpl(::test_object::pmr_allocator::CreatorObject& object, const ::std::pmr::polymorphic_allocator<::std::uint8_t>& alloc = {}) :
                ::zserio::detail::ReflectableDataAllocatorHolderBase<::std::pmr::polymorphic_allocator<::std::uint8_t>>(typeInfo<::test_object::pmr_allocator::CreatorObject>(), alloc),
                m_object(object)
        {}
...
::zserio::pmr::IIntrospectableViewConstPtr Introspectable<::test_object::pmr_allocator::CreatorObject, ::std::pmr::polymorphic_allocator<::std::uint8_t>>::create(
        const View<::test_object::pmr_allocator::CreatorObject>& view, const ::std::pmr::polymorphic_allocator<::std::uint8_t>& allocator)
{
    class IntrospectableImpl : public ::zserio::detail::CompoundIntrospectableViewBase<::test_object::pmr_allocator::CreatorObject, ::std::pmr::polymorphic_allocator<::std::uint8_t>>
    {
    public:
        explicit IntrospectableImpl(const ::zserio::View<::test_object::pmr_allocator::CreatorObject>& view_, const ::std::pmr::polymorphic_allocator<::std::uint8_t>& alloc = {}) :
                ::zserio::detail::CompoundIntrospectableViewBase<::test_object::pmr_allocator::CreatorObject, ::std::pmr::polymorphic_allocator<::std::uint8_t>>(
                        view_, alloc)
        {}
...
::std::size_t hash<::test_object::pmr_allocator::CreatorObject>::operator()(const ::test_object::pmr_allocator::CreatorObject& data) const
{
...
::std::size_t hash<::zserio::View<::test_object::pmr_allocator::CreatorObject>>::operator()(const ::zserio::View<::test_object::pmr_allocator::CreatorObject>& view) const
{
    ::std::uint32_t result = ::zserio::HASH_SEED;
