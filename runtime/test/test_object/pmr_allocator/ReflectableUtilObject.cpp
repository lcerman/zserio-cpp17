...
const ::zserio::pmr::ITypeInfo& TypeInfo<::test_object::pmr_allocator::ReflectableUtilObject, ::std::pmr::polymorphic_allocator<::std::uint8_t>>::get()
{
    ...
    static const ::std::array<::zserio::BasicFieldInfo<AllocatorType>, 2> fields = {
        ...
        ::zserio::BasicFieldInfo<AllocatorType>{
            ...
            ::zserio::typeInfo<::test_object::pmr_allocator::ReflectableUtilChoice, ::std::pmr::polymorphic_allocator<::std::uint8_t>>(), // typeInfo
...
::zserio::pmr::IReflectableDataConstPtr Reflectable<::test_object::pmr_allocator::ReflectableUtilObject, ::std::pmr::polymorphic_allocator<::std::uint8_t>>::create(
        const ::test_object::pmr_allocator::ReflectableUtilObject& value, const ::std::pmr::polymorphic_allocator<::std::uint8_t>& allocator)
{
    ...
    public:
        ...
        explicit ReflectableImpl(const ::test_object::pmr_allocator::ReflectableUtilObject& object, const ::std::pmr::polymorphic_allocator<::std::uint8_t>& alloc = {}) :
                ::zserio::detail::ReflectableDataConstAllocatorHolderBase<::std::pmr::polymorphic_allocator<::std::uint8_t>>(typeInfo<::test_object::pmr_allocator::ReflectableUtilObject>(), alloc),
                m_object(object)
        {}
...
::zserio::pmr::IReflectableDataPtr Reflectable<::test_object::pmr_allocator::ReflectableUtilObject, ::std::pmr::polymorphic_allocator<::std::uint8_t>>::create(
        ::test_object::pmr_allocator::ReflectableUtilObject& value, const ::std::pmr::polymorphic_allocator<::std::uint8_t>& allocator)
{
    ...
    public:
        ...
        explicit ReflectableImpl(::test_object::pmr_allocator::ReflectableUtilObject& object, const ::std::pmr::polymorphic_allocator<::std::uint8_t>& alloc = {}) :
                ::zserio::detail::ReflectableDataAllocatorHolderBase<::std::pmr::polymorphic_allocator<::std::uint8_t>>(typeInfo<::test_object::pmr_allocator::ReflectableUtilObject>(), alloc),
                m_object(object)
        {}
...
::zserio::pmr::IIntrospectableViewConstPtr Introspectable<::test_object::pmr_allocator::ReflectableUtilObject, ::std::pmr::polymorphic_allocator<::std::uint8_t>>::create(
        const View<::test_object::pmr_allocator::ReflectableUtilObject>& view, const ::std::pmr::polymorphic_allocator<::std::uint8_t>& allocator)
{
    class IntrospectableImpl : public ::zserio::detail::CompoundIntrospectableViewBase<::test_object::pmr_allocator::ReflectableUtilObject, ::std::pmr::polymorphic_allocator<::std::uint8_t>>
    {
    public:
        explicit IntrospectableImpl(const ::zserio::View<::test_object::pmr_allocator::ReflectableUtilObject>& view_, const ::std::pmr::polymorphic_allocator<::std::uint8_t>& alloc = {}) :
                ::zserio::detail::CompoundIntrospectableViewBase<::test_object::pmr_allocator::ReflectableUtilObject, ::std::pmr::polymorphic_allocator<::std::uint8_t>>(
                        view_, alloc)
        {}
...
::std::size_t hash<::test_object::pmr_allocator::ReflectableUtilObject>::operator()(const ::test_object::pmr_allocator::ReflectableUtilObject& data) const
{
...
::std::size_t hash<::zserio::View<::test_object::pmr_allocator::ReflectableUtilObject>>::operator()(const ::zserio::View<::test_object::pmr_allocator::ReflectableUtilObject>& view) const
{
    ::std::uint32_t result = ::zserio::HASH_SEED;
