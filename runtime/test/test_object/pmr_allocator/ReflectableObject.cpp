...
#include <test_object/pmr_allocator/ReflectableObject.h>
...
ReflectableObject::ReflectableObject(
        ...
        ::test_object::pmr_allocator::ReflectableNested reflectableNested_,
        ::test_object::pmr_allocator::ReflectableEnum reflectableEnum_,
        ::test_object::pmr_allocator::ReflectableChoice reflectableChoice_,
        ::test_object::pmr_allocator::ReflectableUnion reflectableUnion_,
...
bool operator==(const ::test_object::pmr_allocator::ReflectableObject& lhs, const ::test_object::pmr_allocator::ReflectableObject& rhs)
{
    return ::std::tie(
            lhs.stringField,
...
View<::test_object::pmr_allocator::ReflectableObject>::View(const ::test_object::pmr_allocator::ReflectableObject& data) noexcept :
        m_data(&data)
{}

View<::test_object::pmr_allocator::ReflectableObject>::View(const ::test_object::pmr_allocator::ReflectableObject& data,
        const View&) noexcept :
        m_data(&data)
{}
...
bool operator==(const View<::test_object::pmr_allocator::ReflectableObject>& lhs, const View<::test_object::pmr_allocator::ReflectableObject>& rhs)
{
...
const ::zserio::pmr::ITypeInfo& TypeInfo<::test_object::pmr_allocator::ReflectableObject, ::std::pmr::polymorphic_allocator<::std::uint8_t>>::get()
{
    ...
    static const ::std::array<::zserio::BasicFieldInfo<AllocatorType>, 5> fields = {
        ...
        ::zserio::BasicFieldInfo<AllocatorType>{
            ...
            ::zserio::typeInfo<::test_object::pmr_allocator::ReflectableNested, ::std::pmr::polymorphic_allocator<::std::uint8_t>>(), // typeInfo
        ...
        ::zserio::BasicFieldInfo<AllocatorType>{
            ...
            ::zserio::typeInfo<::test_object::pmr_allocator::ReflectableEnum, ::std::pmr::polymorphic_allocator<::std::uint8_t>>(), // typeInfo
            {}, // typeArguments
            false, // isExtended
            {}, // alignment
            {}, // offset
        ...
        ::zserio::BasicFieldInfo<AllocatorType>{
            ...
            ::zserio::typeInfo<::test_object::pmr_allocator::ReflectableChoice, ::std::pmr::polymorphic_allocator<::std::uint8_t>>(), // typeInfo
        ...
        ::zserio::BasicFieldInfo<AllocatorType>{
            ...
            ::zserio::typeInfo<::test_object::pmr_allocator::ReflectableUnion, ::std::pmr::polymorphic_allocator<::std::uint8_t>>(), // typeInfo
            {}, // typeArguments
            false, // isExtended
            {}, // alignment
            {}, // offset
    ...
    static const ::zserio::detail::StructTypeInfo<AllocatorType> typeInfo = {
        "test_object.pmr_allocator.ReflectableObject",
        [](const AllocatorType& allocator) -> ::zserio::pmr::IReflectableDataPtr
        {
            return ::std::allocate_shared<::zserio::detail::ReflectableDataOwner<::test_object::pmr_allocator::ReflectableObject>>(allocator);
        },
...
::zserio::pmr::IReflectableDataConstPtr Reflectable<::test_object::pmr_allocator::ReflectableObject, ::std::pmr::polymorphic_allocator<::std::uint8_t>>::create(
        const ::test_object::pmr_allocator::ReflectableObject& value, const ::std::pmr::polymorphic_allocator<::std::uint8_t>& allocator)
{
    ...
    public:
        ...
        explicit ReflectableImpl(const ::test_object::pmr_allocator::ReflectableObject& object, const ::std::pmr::polymorphic_allocator<::std::uint8_t>& alloc = {}) :
                ::zserio::detail::ReflectableDataConstAllocatorHolderBase<::std::pmr::polymorphic_allocator<::std::uint8_t>>(typeInfo<::test_object::pmr_allocator::ReflectableObject>(), alloc),
                m_object(object)
        {}
    ...
    private:
        const ::test_object::pmr_allocator::ReflectableObject& m_object;
    };

    return ::std::allocate_shared<ReflectableImpl>(allocator, value);
}

::zserio::pmr::IReflectableDataPtr Reflectable<::test_object::pmr_allocator::ReflectableObject, ::std::pmr::polymorphic_allocator<::std::uint8_t>>::create(
        ::test_object::pmr_allocator::ReflectableObject& value, const ::std::pmr::polymorphic_allocator<::std::uint8_t>& allocator)
{
    ...
    public:
        ...
        explicit ReflectableImpl(::test_object::pmr_allocator::ReflectableObject& object, const ::std::pmr::polymorphic_allocator<::std::uint8_t>& alloc = {}) :
                ::zserio::detail::ReflectableDataAllocatorHolderBase<::std::pmr::polymorphic_allocator<::std::uint8_t>>(typeInfo<::test_object::pmr_allocator::ReflectableObject>(), alloc),
                m_object(object)
        {}
        ...
        void setField(::std::string_view name, const ::zserio::pmr::Any& value) override
        {
            ...
            if (name == "reflectableNested")
            {
                m_object.reflectableNested = ::zserio::ReflectableUtil::fromAny<::test_object::pmr_allocator::ReflectableNested>(value);
                return;
            }
            if (name == "reflectableEnum")
            {
                m_object.reflectableEnum = ::zserio::ReflectableUtil::fromAny<::test_object::pmr_allocator::ReflectableEnum>(value);
                return;
            }
            if (name == "reflectableChoice")
            {
                m_object.reflectableChoice = ::zserio::ReflectableUtil::fromAny<::test_object::pmr_allocator::ReflectableChoice>(value);
                return;
            }
            if (name == "reflectableUnion")
            {
                m_object.reflectableUnion = ::zserio::ReflectableUtil::fromAny<::test_object::pmr_allocator::ReflectableUnion>(value);
                return;
            }
            throw ::zserio::CppRuntimeException("Field '") << name << "' doesn't exist in 'ReflectableObject'!";
        }
        ...
        ::zserio::pmr::IReflectableDataPtr createField(::std::string_view name) override
        {
            ...
            if (name == "reflectableNested")
            {
                m_object.reflectableNested = ::test_object::pmr_allocator::ReflectableNested(get_allocator());
                return ::zserio::reflectable(m_object.reflectableNested, get_allocator());
            }
            if (name == "reflectableEnum")
            {
                m_object.reflectableEnum = ::test_object::pmr_allocator::ReflectableEnum();
                return ::zserio::reflectable(m_object.reflectableEnum, get_allocator());
            }
            if (name == "reflectableChoice")
            {
                m_object.reflectableChoice = ::test_object::pmr_allocator::ReflectableChoice(get_allocator());
                return ::zserio::reflectable(m_object.reflectableChoice, get_allocator());
            }
            if (name == "reflectableUnion")
            {
                m_object.reflectableUnion = ::test_object::pmr_allocator::ReflectableUnion(get_allocator());
                return ::zserio::reflectable(m_object.reflectableUnion, get_allocator());
            }
            throw ::zserio::CppRuntimeException("Field '") << name << "' doesn't exist in 'ReflectableObject'!";
        }
    ...
    private:
        ::test_object::pmr_allocator::ReflectableObject& m_object;
    };

    return ::std::allocate_shared<ReflectableImpl>(allocator, value);
}

::zserio::pmr::IIntrospectableViewConstPtr Introspectable<::test_object::pmr_allocator::ReflectableObject, ::std::pmr::polymorphic_allocator<::std::uint8_t>>::create(
        const View<::test_object::pmr_allocator::ReflectableObject>& view, const ::std::pmr::polymorphic_allocator<::std::uint8_t>& allocator)
{
    class IntrospectableImpl : public ::zserio::detail::CompoundIntrospectableViewBase<::test_object::pmr_allocator::ReflectableObject, ::std::pmr::polymorphic_allocator<::std::uint8_t>>
    {
    public:
        explicit IntrospectableImpl(const ::zserio::View<::test_object::pmr_allocator::ReflectableObject>& view_, const ::std::pmr::polymorphic_allocator<::std::uint8_t>& alloc = {}) :
                ::zserio::detail::CompoundIntrospectableViewBase<::test_object::pmr_allocator::ReflectableObject, ::std::pmr::polymorphic_allocator<::std::uint8_t>>(
                        view_, alloc)
        {}
...
::std::size_t hash<::test_object::pmr_allocator::ReflectableObject>::operator()(const ::test_object::pmr_allocator::ReflectableObject& data) const
{
...
::std::size_t hash<::zserio::View<::test_object::pmr_allocator::ReflectableObject>>::operator()(const ::zserio::View<::test_object::pmr_allocator::ReflectableObject>& view) const
{
    ::std::uint32_t result = ::zserio::HASH_SEED;
