...
#include <test_object/pmr_allocator/WalkerObject.h>
...
View<::test_object::pmr_allocator::WalkerObject>::View(const ::test_object::pmr_allocator::WalkerObject& data) noexcept :
        m_data(&data)
{}

View<::test_object::pmr_allocator::WalkerObject>::View(const ::test_object::pmr_allocator::WalkerObject& data,
        const View&) noexcept :
        m_data(&data)
{}

::zserio::UInt32 View<::test_object::pmr_allocator::WalkerObject>::identifier() const
{
    return m_data->identifier;
}

::zserio::pmr::Optional<View<::test_object::pmr_allocator::WalkerNested>> View<::test_object::pmr_allocator::WalkerObject>::nested() const
{
    if (m_data->nested.has_value())
    {
        return ::zserio::pmr::Optional<View<::test_object::pmr_allocator::WalkerNested>>(::std::in_place, m_data->nested.get_allocator(), *m_data->nested);
    }
    else
    {
        return ::zserio::pmr::Optional<View<::test_object::pmr_allocator::WalkerNested>>(::std::nullopt, m_data->nested.get_allocator());
    }
}

::std::string_view View<::test_object::pmr_allocator::WalkerObject>::text() const
{
    return ::std::string_view(m_data->text);
}

ArrayView<const ::test_object::pmr_allocator::WalkerUnion> View<::test_object::pmr_allocator::WalkerObject>::unionArray() const
{
    return ArrayView<const ::test_object::pmr_allocator::WalkerUnion>(m_data->unionArray);
}

::zserio::pmr::Optional<ArrayView<const ::test_object::pmr_allocator::WalkerUnion>> View<::test_object::pmr_allocator::WalkerObject>::optionalUnionArray() const
{
    if (m_data->optionalUnionArray.has_value())
    {
        return ::zserio::pmr::Optional<ArrayView<const ::test_object::pmr_allocator::WalkerUnion>>(::std::in_place, m_data->optionalUnionArray.get_allocator(), *m_data->optionalUnionArray);
    }
    else
    {
        return ::zserio::pmr::Optional<ArrayView<const ::test_object::pmr_allocator::WalkerUnion>>(::std::nullopt, m_data->optionalUnionArray.get_allocator());
    }
}

::zserio::UInt8 View<::test_object::pmr_allocator::WalkerObject>::choiceSelector() const
{
    return m_data->choiceSelector;
}

View<::test_object::pmr_allocator::WalkerChoice> View<::test_object::pmr_allocator::WalkerObject>::choiceField() const
{
    return View<::test_object::pmr_allocator::WalkerChoice>(m_data->choiceField, detail::makeParameter<0, ::test_object::pmr_allocator::WalkerChoice>(choiceSelector()));
}

const ::test_object::pmr_allocator::WalkerObject& View<::test_object::pmr_allocator::WalkerObject>::zserioData() const
{
    return *m_data;
}
...
void ObjectTraits<::test_object::pmr_allocator::WalkerObject>::validate(const View<::test_object::pmr_allocator::WalkerObject>& view, ::std::string_view)
{
...
BitSize ObjectTraits<::test_object::pmr_allocator::WalkerObject>::bitSizeOf(const View<::test_object::pmr_allocator::WalkerObject>& view, BitSize bitPosition)
{
...
void ObjectTraits<::test_object::pmr_allocator::WalkerObject>::write(BitStreamWriter& writer, const View<::test_object::pmr_allocator::WalkerObject>& view)
{
    auto identifier_ = view.identifier();
...
View<::test_object::pmr_allocator::WalkerObject> ObjectTraits<::test_object::pmr_allocator::WalkerObject>::read(BitStreamReader& reader, ::test_object::pmr_allocator::WalkerObject& data)
{
    View<::test_object::pmr_allocator::WalkerObject> view(data);
    ...
    {
        data.optionalUnionArray.reset();
    }
    detail::read(reader, data.choiceSelector);
    (void)detail::read(reader, data.choiceField, detail::makeParameter<0, ::test_object::pmr_allocator::WalkerChoice>(view.choiceSelector()));
    return view;
}

const ::zserio::pmr::ITypeInfo& TypeInfo<::test_object::pmr_allocator::WalkerObject, ::std::pmr::polymorphic_allocator<::std::uint8_t>>::get()
{
    using AllocatorType = ::std::pmr::polymorphic_allocator<::std::uint8_t>;
    ...
    static const ::std::array<::zserio::BasicFieldInfo<AllocatorType>, 7> fields = {
        ::zserio::BasicFieldInfo<AllocatorType>{
            ...
            ::zserio::typeInfo<::zserio::UInt32, ::std::pmr::polymorphic_allocator<::std::uint8_t>>(), // typeInfo
            {}, // typeArguments
            false, // isExtended
            {}, // alignment
            {}, // offset
        ...
        ::zserio::BasicFieldInfo<AllocatorType>{
            "nested", // schemaName
            ::zserio::typeInfo<::test_object::pmr_allocator::WalkerNested, ::std::pmr::polymorphic_allocator<::std::uint8_t>>(), // typeInfo
            {}, // typeArguments
            false, // isExtended
            {}, // alignment
            {}, // offset
        ...
        ::zserio::BasicFieldInfo<AllocatorType>{
            "text", // schemaName
            ::zserio::typeInfo<::zserio::pmr::String, ::std::pmr::polymorphic_allocator<::std::uint8_t>>(), // typeInfo
            {}, // typeArguments
            false, // isExtended
            {}, // alignment
            {}, // offset
        ...
        ::zserio::BasicFieldInfo<AllocatorType>{
            ...
            ::zserio::typeInfo<::test_object::pmr_allocator::WalkerUnion, ::std::pmr::polymorphic_allocator<::std::uint8_t>>(), // typeInfo
            {}, // typeArguments
            false, // isExtended
            {}, // alignment
            {}, // offset
        ...
        ::zserio::BasicFieldInfo<AllocatorType>{
            ...
            ::zserio::typeInfo<::zserio::UInt8, ::std::pmr::polymorphic_allocator<::std::uint8_t>>(), // typeInfo
            {}, // typeArguments
            false, // isExtended
            {}, // alignment
            {}, // offset
        ...
        ::zserio::BasicFieldInfo<AllocatorType>{
            ...
            ::zserio::typeInfo<::test_object::pmr_allocator::WalkerChoice, ::std::pmr::polymorphic_allocator<::std::uint8_t>>(), // typeInfo
    ...
    static const ::zserio::detail::StructTypeInfo<AllocatorType> typeInfo = {
        "test_object.pmr_allocator.WalkerObject",
        [](const AllocatorType& allocator) -> ::zserio::pmr::IReflectableDataPtr
        {
            return ::std::allocate_shared<::zserio::detail::ReflectableDataOwner<::test_object::pmr_allocator::WalkerObject>>(allocator);
        },
...
::zserio::pmr::IReflectableDataConstPtr Reflectable<::test_object::pmr_allocator::WalkerObject, ::std::pmr::polymorphic_allocator<::std::uint8_t>>::create(
        const ::test_object::pmr_allocator::WalkerObject& value, const ::std::pmr::polymorphic_allocator<::std::uint8_t>& allocator)
{
    class ReflectableImpl : public ::zserio::detail::ReflectableDataConstAllocatorHolderBase<::std::pmr::polymorphic_allocator<::std::uint8_t>>
    {
    public:
        using Base = ::zserio::detail::ReflectableDataConstAllocatorHolderBase<::std::pmr::polymorphic_allocator<::std::uint8_t>>;
        using Base::getField;
        using Base::getAnyValue;

        explicit ReflectableImpl(const ::test_object::pmr_allocator::WalkerObject& object, const ::std::pmr::polymorphic_allocator<::std::uint8_t>& alloc = {}) :
                ::zserio::detail::ReflectableDataConstAllocatorHolderBase<::std::pmr::polymorphic_allocator<::std::uint8_t>>(typeInfo<::test_object::pmr_allocator::WalkerObject>(), alloc),
                m_object(object)
        {}
        ...
        ::zserio::pmr::Any getAnyValue(const ::std::pmr::polymorphic_allocator<::std::uint8_t>& alloc) const override
        {
            return ::zserio::pmr::Any(::std::cref(m_object), alloc);
        }

    private:
        const ::test_object::pmr_allocator::WalkerObject& m_object;
    };

    return ::std::allocate_shared<ReflectableImpl>(allocator, value);
}

::zserio::pmr::IReflectableDataPtr Reflectable<::test_object::pmr_allocator::WalkerObject, ::std::pmr::polymorphic_allocator<::std::uint8_t>>::create(
        ::test_object::pmr_allocator::WalkerObject& value, const ::std::pmr::polymorphic_allocator<::std::uint8_t>& allocator)
{
    class ReflectableImpl : public ::zserio::detail::ReflectableDataAllocatorHolderBase<::std::pmr::polymorphic_allocator<::std::uint8_t>>
    {
    public:
        using Base = ::zserio::detail::ReflectableDataAllocatorHolderBase<::std::pmr::polymorphic_allocator<::std::uint8_t>>;
        using Base::getField;
        using Base::getAnyValue;

        explicit ReflectableImpl(::test_object::pmr_allocator::WalkerObject& object, const ::std::pmr::polymorphic_allocator<::std::uint8_t>& alloc = {}) :
                ::zserio::detail::ReflectableDataAllocatorHolderBase<::std::pmr::polymorphic_allocator<::std::uint8_t>>(typeInfo<::test_object::pmr_allocator::WalkerObject>(), alloc),
                m_object(object)
        {}
        ...
        void setField(::std::string_view name, const ::zserio::pmr::Any& value) override
        {
            ...
            if (name == "nested")
            {
                ...
                m_object.nested = ::zserio::ReflectableUtil::fromAny<::test_object::pmr_allocator::WalkerNested>(value);
                return;
            }
            if (name == "text")
            {
            ...
            if (name == "unionArray")
            {
                m_object.unionArray = ::zserio::ReflectableUtil::fromAny<::zserio::pmr::Vector<::test_object::pmr_allocator::WalkerUnion>>(value);
                return;
            }
            if (name == "optionalUnionArray")
            {
                ...
                m_object.optionalUnionArray = ::zserio::ReflectableUtil::fromAny<::zserio::pmr::Vector<::test_object::pmr_allocator::WalkerUnion>>(value);
                return;
            }
            if (name == "choiceSelector")
            {
            ...
            if (name == "choiceField")
            {
                m_object.choiceField = ::zserio::ReflectableUtil::fromAny<::test_object::pmr_allocator::WalkerChoice>(value);
                return;
            }
            throw ::zserio::CppRuntimeException("Field '") << name << "' doesn't exist in 'WalkerObject'!";
        }
        ...
        ::zserio::pmr::IReflectableDataPtr createField(::std::string_view name) override
        {
            ...
            if (name == "nested")
            {
                m_object.nested = ::test_object::pmr_allocator::WalkerNested(get_allocator());
                return ::zserio::reflectable(*m_object.nested, get_allocator());
            }
            if (name == "text")
            {
            ...
            if (name == "unionArray")
            {
                m_object.unionArray = ::zserio::pmr::Vector<::test_object::pmr_allocator::WalkerUnion>(get_allocator());
                return ::zserio::reflectableArray(m_object.unionArray, get_allocator());
            }
            if (name == "optionalUnionArray")
            {
                m_object.optionalUnionArray = ::zserio::pmr::Vector<::test_object::pmr_allocator::WalkerUnion>(get_allocator());
                return ::zserio::reflectableArray(*m_object.optionalUnionArray, get_allocator());
            }
            if (name == "choiceSelector")
            {
            ...
            if (name == "choiceField")
            {
                m_object.choiceField = ::test_object::pmr_allocator::WalkerChoice(get_allocator());
                return ::zserio::reflectable(m_object.choiceField, get_allocator());
            }
            throw ::zserio::CppRuntimeException("Field '") << name << "' doesn't exist in 'WalkerObject'!";
        }
        ...
        ::zserio::pmr::Any getAnyValue(const ::std::pmr::polymorphic_allocator<::std::uint8_t>& alloc) override
        {
            return ::zserio::pmr::Any(::std::ref(m_object), alloc);
        }

    private:
        ::test_object::pmr_allocator::WalkerObject& m_object;
    };

    return ::std::allocate_shared<ReflectableImpl>(allocator, value);
}

::zserio::pmr::IIntrospectableViewConstPtr Introspectable<::test_object::pmr_allocator::WalkerObject, ::std::pmr::polymorphic_allocator<::std::uint8_t>>::create(
        const View<::test_object::pmr_allocator::WalkerObject>& view, const ::std::pmr::polymorphic_allocator<::std::uint8_t>& allocator)
{
    class IntrospectableImpl : public ::zserio::detail::CompoundIntrospectableViewBase<::test_object::pmr_allocator::WalkerObject, ::std::pmr::polymorphic_allocator<::std::uint8_t>>
    {
    public:
        explicit IntrospectableImpl(const ::zserio::View<::test_object::pmr_allocator::WalkerObject>& view_, const ::std::pmr::polymorphic_allocator<::std::uint8_t>& alloc = {}) :
                ::zserio::detail::CompoundIntrospectableViewBase<::test_object::pmr_allocator::WalkerObject, ::std::pmr::polymorphic_allocator<::std::uint8_t>>(
                        view_, alloc)
        {}
...
::std::size_t hash<::test_object::pmr_allocator::WalkerObject>::operator()(const ::test_object::pmr_allocator::WalkerObject& data) const
{
...
::std::size_t hash<::zserio::View<::test_object::pmr_allocator::WalkerObject>>::operator()(const ::zserio::View<::test_object::pmr_allocator::WalkerObject>& view) const
{
    ::std::uint32_t result = ::zserio::HASH_SEED;
