...
template <>
struct TypeInfo<::test_object::pmr_allocator::WalkerBitmask, ::std::pmr::polymorphic_allocator<::std::uint8_t>>
{
...
{
    ::std::size_t operator()(const ::test_object::pmr_allocator::WalkerBitmask& value) const;
};
