...
public:
    struct ZserioNestedArrayArrayTraits
    {
        ...
        static View<::test_object::pmr_allocator::CreatorNested> at(const OwnerType& owner,
                const ::test_object::pmr_allocator::CreatorNested& element, ::std::size_t index);

        static void read(BitStreamReader& reader, const OwnerType& owner,
                ::test_object::pmr_allocator::CreatorNested& element, ::std::size_t index);
    };
...
template <>
struct ObjectTraits<::test_object::pmr_allocator::CreatorObject>
{
    static void validate(const View<::test_object::pmr_allocator::CreatorObject>& view, ::std::string_view fieldName);

    static BitSize bitSizeOf(const View<::test_object::pmr_allocator::CreatorObject>& view, BitSize bitPosition);

    static void write(BitStreamWriter& writer, const View<::test_object::pmr_allocator::CreatorObject>& view);

    static View<::test_object::pmr_allocator::CreatorObject> read(BitStreamReader& reader, ::test_object::pmr_allocator::CreatorObject& data);
};

template <>
struct TypeInfo<::test_object::pmr_allocator::CreatorObject, ::std::pmr::polymorphic_allocator<::std::uint8_t>>
{
    static const ::zserio::pmr::ITypeInfo& get();
};

template <>
struct Reflectable<::test_object::pmr_allocator::CreatorObject, ::std::pmr::polymorphic_allocator<::std::uint8_t>>
{
    static ::zserio::pmr::IReflectableDataConstPtr create(const ::test_object::pmr_allocator::CreatorObject& value,
            const ::std::pmr::polymorphic_allocator<::std::uint8_t>& allocator);

    static ::zserio::pmr::IReflectableDataPtr create(::test_object::pmr_allocator::CreatorObject& value,
            const ::std::pmr::polymorphic_allocator<::std::uint8_t>& allocator);
};

template <>
struct Introspectable<::test_object::pmr_allocator::CreatorObject, ::std::pmr::polymorphic_allocator<::std::uint8_t>>
{
    static ::zserio::pmr::IIntrospectableViewConstPtr create(const View<::test_object::pmr_allocator::CreatorObject>& view,
            const ::std::pmr::polymorphic_allocator<::std::uint8_t>& allocator);
};
...
{
    ::std::size_t operator()(const ::test_object::pmr_allocator::CreatorObject& data) const;
};

template <>
struct hash<::zserio::View<::test_object::pmr_allocator::CreatorObject>>
{
    ::std::size_t operator()(const ::zserio::View<::test_object::pmr_allocator::CreatorObject>& view) const;
};
