...
#ifndef TEST_OBJECT_PMR_ALLOCATOR_CREATOR_BITMASK_H
#define TEST_OBJECT_PMR_ALLOCATOR_CREATOR_BITMASK_H
...
template <>
struct TypeInfo<::test_object::pmr_allocator::CreatorBitmask, ::std::pmr::polymorphic_allocator<::std::uint8_t>>
{
...
template <>
struct hash<::test_object::pmr_allocator::CreatorBitmask>
{
    ::std::size_t operator()(const ::test_object::pmr_allocator::CreatorBitmask& value) const;
};

} // namespace std

#endif // TEST_OBJECT_PMR_ALLOCATOR_CREATOR_BITMASK_H
