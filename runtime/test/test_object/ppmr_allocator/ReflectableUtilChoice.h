...
template <>
struct TypeInfo<::test_object::ppmr_allocator::ReflectableUtilChoice, ::zserio::ppmr::PropagatingPolymorphicAllocator<::std::uint8_t>>
{
    static const ::zserio::ppmr::ITypeInfo& get();
};

template <>
struct Reflectable<::test_object::ppmr_allocator::ReflectableUtilChoice, ::zserio::ppmr::PropagatingPolymorphicAllocator<::std::uint8_t>>
{
...
template <>
struct Introspectable<::test_object::ppmr_allocator::ReflectableUtilChoice, ::zserio::ppmr::PropagatingPolymorphicAllocator<::std::uint8_t>>
{
...
{
    ::std::size_t operator()(const ::test_object::ppmr_allocator::ReflectableUtilChoice& value) const;
};

template <>
struct hash<::zserio::View<::test_object::ppmr_allocator::ReflectableUtilChoice>>
{
    ::std::size_t operator()(const ::zserio::View<::test_object::ppmr_allocator::ReflectableUtilChoice>& view) const;
};
