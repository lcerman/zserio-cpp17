...
#ifndef TEST_OBJECT_PPMR_ALLOCATOR_REFLECTABLE_UTIL_BITMASK_H
#define TEST_OBJECT_PPMR_ALLOCATOR_REFLECTABLE_UTIL_BITMASK_H
...
template <>
struct TypeInfo<::test_object::ppmr_allocator::ReflectableUtilBitmask, ::zserio::ppmr::PropagatingPolymorphicAllocator<::std::uint8_t>>
{
...
template <>
struct hash<::test_object::ppmr_allocator::ReflectableUtilBitmask>
{
    ::std::size_t operator()(const ::test_object::ppmr_allocator::ReflectableUtilBitmask& value) const;
};

} // namespace std

#endif // TEST_OBJECT_PPMR_ALLOCATOR_REFLECTABLE_UTIL_BITMASK_H
