...
template <>
::std::size_t enumToOrdinal<::test_object::ppmr_allocator::CreatorEnum>(::test_object::ppmr_allocator::CreatorEnum value);
...
template <>
struct TypeInfo<::test_object::ppmr_allocator::CreatorEnum, ::zserio::ppmr::PropagatingPolymorphicAllocator<::std::uint8_t>>
{
...
{
    ::std::size_t operator()(const ::test_object::ppmr_allocator::CreatorEnum& value) const;
};
