...
View<::test_object::ppmr_allocator::WalkerObject>::View(const ::test_object::ppmr_allocator::WalkerObject& data) noexcept :
        m_data(&data)
{}

View<::test_object::ppmr_allocator::WalkerObject>::View(const ::test_object::ppmr_allocator::WalkerObject& data,
        const View&) noexcept :
        m_data(&data)
{}

::zserio::UInt32 View<::test_object::ppmr_allocator::WalkerObject>::identifier() const
{
    return m_data->identifier;
}

::zserio::ppmr::Optional<View<::test_object::ppmr_allocator::WalkerNested>> View<::test_object::ppmr_allocator::WalkerObject>::nested() const
{
    ...
    {
        return ::zserio::ppmr::Optional<View<::test_object::ppmr_allocator::WalkerNested>>(::std::nullopt, m_data->nested.get_allocator());
    }
}
...
::zserio::ppmr::Optional<ArrayView<const ::test_object::ppmr_allocator::WalkerUnion>> View<::test_object::ppmr_allocator::WalkerObject>::optionalUnionArray() const
{
    ...
    {
        return ::zserio::ppmr::Optional<ArrayView<const ::test_object::ppmr_allocator::WalkerUnion>>(::std::nullopt, m_data->optionalUnionArray.get_allocator());
    }
}

::zserio::UInt8 View<::test_object::ppmr_allocator::WalkerObject>::choiceSelector() const
{
...
void ObjectTraits<::test_object::ppmr_allocator::WalkerObject>::validate(const View<::test_object::ppmr_allocator::WalkerObject>& view, ::std::string_view)
{
...
BitSize ObjectTraits<::test_object::ppmr_allocator::WalkerObject>::bitSizeOf(const View<::test_object::ppmr_allocator::WalkerObject>& view, BitSize bitPosition)
{
...
void ObjectTraits<::test_object::ppmr_allocator::WalkerObject>::write(BitStreamWriter& writer, const View<::test_object::ppmr_allocator::WalkerObject>& view)
{
    auto identifier_ = view.identifier();
...
View<::test_object::ppmr_allocator::WalkerObject> ObjectTraits<::test_object::ppmr_allocator::WalkerObject>::read(BitStreamReader& reader, ::test_object::ppmr_allocator::WalkerObject& data)
{
    View<::test_object::ppmr_allocator::WalkerObject> view(data);
    ...
    (void)detail::read(reader, data.choiceField, detail::makeParameter<0, ::test_object::ppmr_allocator::WalkerChoice>(view.choiceSelector()));
    return view;
}

const ::zserio::ppmr::ITypeInfo& TypeInfo<::test_object::ppmr_allocator::WalkerObject, ::zserio::ppmr::PropagatingPolymorphicAllocator<::std::uint8_t>>::get()
{
    ...
    static const ::std::array<::zserio::BasicFieldInfo<AllocatorType>, 7> fields = {
        ::zserio::BasicFieldInfo<AllocatorType>{
            ...
            ::zserio::typeInfo<::zserio::UInt32, ::zserio::ppmr::PropagatingPolymorphicAllocator<::std::uint8_t>>(), // typeInfo
            {}, // typeArguments
            false, // isExtended
            {}, // alignment
            {}, // offset
        ...
        ::zserio::BasicFieldInfo<AllocatorType>{
            "nested", // schemaName
            ::zserio::typeInfo<::test_object::ppmr_allocator::WalkerNested, ::zserio::ppmr::PropagatingPolymorphicAllocator<::std::uint8_t>>(), // typeInfo
            {}, // typeArguments
            false, // isExtended
            {}, // alignment
            {}, // offset
        ...
        ::zserio::BasicFieldInfo<AllocatorType>{
            "text", // schemaName
            ::zserio::typeInfo<::zserio::ppmr::String, ::zserio::ppmr::PropagatingPolymorphicAllocator<::std::uint8_t>>(), // typeInfo
            {}, // typeArguments
            false, // isExtended
            {}, // alignment
            {}, // offset
        ...
        ::zserio::BasicFieldInfo<AllocatorType>{
            ...
            ::zserio::typeInfo<::test_object::ppmr_allocator::WalkerUnion, ::zserio::ppmr::PropagatingPolymorphicAllocator<::std::uint8_t>>(), // typeInfo
            {}, // typeArguments
            false, // isExtended
            {}, // alignment
            {}, // offset
        ...
        ::zserio::BasicFieldInfo<AllocatorType>{
            ...
            ::zserio::typeInfo<::zserio::UInt8, ::zserio::ppmr::PropagatingPolymorphicAllocator<::std::uint8_t>>(), // typeInfo
            {}, // typeArguments
            false, // isExtended
            {}, // alignment
            {}, // offset
        ...
        ::zserio::BasicFieldInfo<AllocatorType>{
            ...
            ::zserio::typeInfo<::test_object::ppmr_allocator::WalkerChoice, ::zserio::ppmr::PropagatingPolymorphicAllocator<::std::uint8_t>>(), // typeInfo
    ...
    static const ::zserio::detail::StructTypeInfo<AllocatorType> typeInfo = {
        "test_object.ppmr_allocator.WalkerObject",
        [](const AllocatorType& allocator) -> ::zserio::ppmr::IReflectableDataPtr
        {
            return ::std::allocate_shared<::zserio::detail::ReflectableDataOwner<::test_object::ppmr_allocator::WalkerObject>>(allocator);
        },
...
::zserio::ppmr::IReflectableDataConstPtr Reflectable<::test_object::ppmr_allocator::WalkerObject, ::zserio::ppmr::PropagatingPolymorphicAllocator<::std::uint8_t>>::create(
        const ::test_object::ppmr_allocator::WalkerObject& value, const ::zserio::ppmr::PropagatingPolymorphicAllocator<::std::uint8_t>& allocator)
{
    ...
    public:
        ...
        explicit ReflectableImpl(const ::test_object::ppmr_allocator::WalkerObject& object, const ::zserio::ppmr::PropagatingPolymorphicAllocator<::std::uint8_t>& alloc = {}) :
                ::zserio::detail::ReflectableDataConstAllocatorHolderBase<::zserio::ppmr::PropagatingPolymorphicAllocator<::std::uint8_t>>(typeInfo<::test_object::ppmr_allocator::WalkerObject>(), alloc),
                m_object(object)
        {}
    ...
    private:
        const ::test_object::ppmr_allocator::WalkerObject& m_object;
    };

    return ::std::allocate_shared<ReflectableImpl>(allocator, value);
}

::zserio::ppmr::IReflectableDataPtr Reflectable<::test_object::ppmr_allocator::WalkerObject, ::zserio::ppmr::PropagatingPolymorphicAllocator<::std::uint8_t>>::create(
        ::test_object::ppmr_allocator::WalkerObject& value, const ::zserio::ppmr::PropagatingPolymorphicAllocator<::std::uint8_t>& allocator)
{
    ...
    public:
        ...
        explicit ReflectableImpl(::test_object::ppmr_allocator::WalkerObject& object, const ::zserio::ppmr::PropagatingPolymorphicAllocator<::std::uint8_t>& alloc = {}) :
                ::zserio::detail::ReflectableDataAllocatorHolderBase<::zserio::ppmr::PropagatingPolymorphicAllocator<::std::uint8_t>>(typeInfo<::test_object::ppmr_allocator::WalkerObject>(), alloc),
                m_object(object)
        {}
        ...
        void setField(::std::string_view name, const ::zserio::ppmr::Any& value) override
        {
            ...
            if (name == "nested")
            {
                ...
                m_object.nested = ::zserio::ReflectableUtil::fromAny<::test_object::ppmr_allocator::WalkerNested>(value);
                return;
            }
            if (name == "text")
            {
            ...
            if (name == "unionArray")
            {
                m_object.unionArray = ::zserio::ReflectableUtil::fromAny<::zserio::ppmr::Vector<::test_object::ppmr_allocator::WalkerUnion>>(value);
                return;
            }
            if (name == "optionalUnionArray")
            {
                ...
                m_object.optionalUnionArray = ::zserio::ReflectableUtil::fromAny<::zserio::ppmr::Vector<::test_object::ppmr_allocator::WalkerUnion>>(value);
                return;
            }
            if (name == "choiceSelector")
            {
            ...
            if (name == "choiceField")
            {
                m_object.choiceField = ::zserio::ReflectableUtil::fromAny<::test_object::ppmr_allocator::WalkerChoice>(value);
                return;
            }
            throw ::zserio::CppRuntimeException("Field '") << name << "' doesn't exist in 'WalkerObject'!";
        }
        ...
        ::zserio::ppmr::IReflectableDataPtr createField(::std::string_view name) override
        {
            ...
            if (name == "nested")
            {
                m_object.nested = ::test_object::ppmr_allocator::WalkerNested(get_allocator());
                return ::zserio::reflectable(*m_object.nested, get_allocator());
            }
            if (name == "text")
            {
            ...
            if (name == "unionArray")
            {
                m_object.unionArray = ::zserio::ppmr::Vector<::test_object::ppmr_allocator::WalkerUnion>(get_allocator());
                return ::zserio::reflectableArray(m_object.unionArray, get_allocator());
            }
            if (name == "optionalUnionArray")
            {
                m_object.optionalUnionArray = ::zserio::ppmr::Vector<::test_object::ppmr_allocator::WalkerUnion>(get_allocator());
                return ::zserio::reflectableArray(*m_object.optionalUnionArray, get_allocator());
            }
            if (name == "choiceSelector")
            {
            ...
            if (name == "choiceField")
            {
                m_object.choiceField = ::test_object::ppmr_allocator::WalkerChoice(get_allocator());
                return ::zserio::reflectable(m_object.choiceField, get_allocator());
            }
            throw ::zserio::CppRuntimeException("Field '") << name << "' doesn't exist in 'WalkerObject'!";
        }
    ...
    private:
        ::test_object::ppmr_allocator::WalkerObject& m_object;
    };

    return ::std::allocate_shared<ReflectableImpl>(allocator, value);
}

::zserio::ppmr::IIntrospectableViewConstPtr Introspectable<::test_object::ppmr_allocator::WalkerObject, ::zserio::ppmr::PropagatingPolymorphicAllocator<::std::uint8_t>>::create(
        const View<::test_object::ppmr_allocator::WalkerObject>& view, const ::zserio::ppmr::PropagatingPolymorphicAllocator<::std::uint8_t>& allocator)
{
    class IntrospectableImpl : public ::zserio::detail::CompoundIntrospectableViewBase<::test_object::ppmr_allocator::WalkerObject, ::zserio::ppmr::PropagatingPolymorphicAllocator<::std::uint8_t>>
    {
    public:
        explicit IntrospectableImpl(const ::zserio::View<::test_object::ppmr_allocator::WalkerObject>& view_, const ::zserio::ppmr::PropagatingPolymorphicAllocator<::std::uint8_t>& alloc = {}) :
                ::zserio::detail::CompoundIntrospectableViewBase<::test_object::ppmr_allocator::WalkerObject, ::zserio::ppmr::PropagatingPolymorphicAllocator<::std::uint8_t>>(
                        view_, alloc)
        {}
...
::std::size_t hash<::test_object::ppmr_allocator::WalkerObject>::operator()(const ::test_object::ppmr_allocator::WalkerObject& data) const
{
...
::std::size_t hash<::zserio::View<::test_object::ppmr_allocator::WalkerObject>>::operator()(const ::zserio::View<::test_object::ppmr_allocator::WalkerObject>& view) const
{
    ::std::uint32_t result = ::zserio::HASH_SEED;
