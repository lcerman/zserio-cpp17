...
void ObjectTraits<::test_object::ppmr_allocator::WalkerChoice>::validate(const View<::test_object::ppmr_allocator::WalkerChoice>& view, ::std::string_view)
{
    ...
    case 8:
        ...
        if (view.zserioChoiceTag() != ::test_object::ppmr_allocator::WalkerChoice::Tag::value8)
        {
            throw ChoiceCaseException("Wrong case set in choice 'WalkerChoice' (") << static_cast<::std::size_t>(view.zserioChoiceTag()) <<
                    " != " << static_cast<::std::size_t>(::test_object::ppmr_allocator::WalkerChoice::Tag::value8) << ")!";
        }
    ...
    case 16:
        ...
        {
            throw ChoiceCaseException("Wrong case set in choice 'WalkerChoice' (") << static_cast<::std::size_t>(view.zserioChoiceTag()) <<
                    " != " << static_cast<::std::size_t>(::test_object::ppmr_allocator::WalkerChoice::Tag::value16) << ")!";
        }
    ...
    case 32:
        ...
        {
            throw ChoiceCaseException("Wrong case set in choice 'WalkerChoice' (") << static_cast<::std::size_t>(view.zserioChoiceTag()) <<
                    " != " << static_cast<::std::size_t>(::test_object::ppmr_allocator::WalkerChoice::Tag::value32) << ")!";
        }
    ...
    case 64:
        ...
        {
            throw ChoiceCaseException("Wrong case set in choice 'WalkerChoice' (") << static_cast<::std::size_t>(view.zserioChoiceTag()) <<
                    " != " << static_cast<::std::size_t>(::test_object::ppmr_allocator::WalkerChoice::Tag::value64) << ")!";
        }
...
const ::zserio::ppmr::ITypeInfo& TypeInfo<::test_object::ppmr_allocator::WalkerChoice, ::zserio::ppmr::PropagatingPolymorphicAllocator<::std::uint8_t>>::get()
{
    ...
    static const ::std::array<::zserio::BasicFieldInfo<AllocatorType>, 4> fields = {
        ...
        ::zserio::BasicFieldInfo<AllocatorType>{
            "value16", // schemaName
            ::zserio::typeInfo<::zserio::UInt16, ::zserio::ppmr::PropagatingPolymorphicAllocator<::std::uint8_t>>(), // typeInfo
            {}, // typeArguments
            false, // isExtended
            {}, // alignment
            {}, // offset
        ...
        ::zserio::BasicFieldInfo<AllocatorType>{
            "value64", // schemaName
            ::zserio::typeInfo<::zserio::UInt64, ::zserio::ppmr::PropagatingPolymorphicAllocator<::std::uint8_t>>(), // typeInfo
            {}, // typeArguments
            false, // isExtended
            {}, // alignment
            {}, // offset
    ...
    static const ::std::array<::zserio::BasicParameterInfo<AllocatorType>, 1> parameters = {
        ::zserio::BasicParameterInfo<AllocatorType>{
            "selector",
            ::zserio::typeInfo<::zserio::UInt8, ::zserio::ppmr::PropagatingPolymorphicAllocator<::std::uint8_t>>()
        }
    };
...
::zserio::ppmr::IReflectableDataConstPtr Reflectable<::test_object::ppmr_allocator::WalkerChoice, ::zserio::ppmr::PropagatingPolymorphicAllocator<::std::uint8_t>>::create(
        const ::test_object::ppmr_allocator::WalkerChoice& value, const ::zserio::ppmr::PropagatingPolymorphicAllocator<::std::uint8_t>& allocator)
{
    ...
    public:
        ...
        explicit ReflectableImpl(const ::test_object::ppmr_allocator::WalkerChoice& object, const ::zserio::ppmr::PropagatingPolymorphicAllocator<::std::uint8_t>& alloc = {}) :
                ::zserio::detail::ReflectableDataConstAllocatorHolderBase<::zserio::ppmr::PropagatingPolymorphicAllocator<::std::uint8_t>>(typeInfo<::test_object::ppmr_allocator::WalkerChoice>(), alloc),
                m_object(object)
        {}
...
::zserio::ppmr::IReflectableDataPtr Reflectable<::test_object::ppmr_allocator::WalkerChoice, ::zserio::ppmr::PropagatingPolymorphicAllocator<::std::uint8_t>>::create(
        ::test_object::ppmr_allocator::WalkerChoice& value, const ::zserio::ppmr::PropagatingPolymorphicAllocator<::std::uint8_t>& allocator)
{
    ...
    public:
        ...
        explicit ReflectableImpl(::test_object::ppmr_allocator::WalkerChoice& object, const ::zserio::ppmr::PropagatingPolymorphicAllocator<::std::uint8_t>& alloc = {}) :
                ::zserio::detail::ReflectableDataAllocatorHolderBase<::zserio::ppmr::PropagatingPolymorphicAllocator<::std::uint8_t>>(typeInfo<::test_object::ppmr_allocator::WalkerChoice>(), alloc),
                m_object(object)
        {}
...
::zserio::ppmr::IIntrospectableViewConstPtr Introspectable<::test_object::ppmr_allocator::WalkerChoice, ::zserio::ppmr::PropagatingPolymorphicAllocator<::std::uint8_t>>::create(
        const View<::test_object::ppmr_allocator::WalkerChoice>& view, const ::zserio::ppmr::PropagatingPolymorphicAllocator<::std::uint8_t>& allocator)
{
    class IntrospectableImpl : public ::zserio::detail::CompoundIntrospectableViewBase<::test_object::ppmr_allocator::WalkerChoice, ::zserio::ppmr::PropagatingPolymorphicAllocator<::std::uint8_t>>
    {
    public:
        explicit IntrospectableImpl(const ::zserio::View<::test_object::ppmr_allocator::WalkerChoice>& view_, const ::zserio::ppmr::PropagatingPolymorphicAllocator<::std::uint8_t>& alloc = {}) :
                ::zserio::detail::CompoundIntrospectableViewBase<::test_object::ppmr_allocator::WalkerChoice, ::zserio::ppmr::PropagatingPolymorphicAllocator<::std::uint8_t>>(
                        view_, alloc)
        {}
...
::std::size_t hash<::test_object::ppmr_allocator::WalkerChoice>::operator()(const ::test_object::ppmr_allocator::WalkerChoice& value) const
{
...
::std::size_t hash<::zserio::View<::test_object::ppmr_allocator::WalkerChoice>>::operator()(const ::zserio::View<::test_object::ppmr_allocator::WalkerChoice>& view) const
{
    ::std::uint32_t result = ::zserio::HASH_SEED;
