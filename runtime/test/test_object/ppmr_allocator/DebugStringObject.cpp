...
const ::zserio::ppmr::ITypeInfo& TypeInfo<::test_object::ppmr_allocator::DebugStringObject, ::zserio::ppmr::PropagatingPolymorphicAllocator<::std::uint8_t>>::get()
{
...
::zserio::ppmr::IReflectableDataConstPtr Reflectable<::test_object::ppmr_allocator::DebugStringObject, ::zserio::ppmr::PropagatingPolymorphicAllocator<::std::uint8_t>>::create(
        const ::test_object::ppmr_allocator::DebugStringObject& value, const ::zserio::ppmr::PropagatingPolymorphicAllocator<::std::uint8_t>& allocator)
{
    ...
    public:
        ...
        explicit ReflectableImpl(const ::test_object::ppmr_allocator::DebugStringObject& object, const ::zserio::ppmr::PropagatingPolymorphicAllocator<::std::uint8_t>& alloc = {}) :
                ::zserio::detail::ReflectableDataConstAllocatorHolderBase<::zserio::ppmr::PropagatingPolymorphicAllocator<::std::uint8_t>>(typeInfo<::test_object::ppmr_allocator::DebugStringObject>(), alloc),
                m_object(object)
        {}
...
::zserio::ppmr::IReflectableDataPtr Reflectable<::test_object::ppmr_allocator::DebugStringObject, ::zserio::ppmr::PropagatingPolymorphicAllocator<::std::uint8_t>>::create(
        ::test_object::ppmr_allocator::DebugStringObject& value, const ::zserio::ppmr::PropagatingPolymorphicAllocator<::std::uint8_t>& allocator)
{
    ...
    public:
        ...
        explicit ReflectableImpl(::test_object::ppmr_allocator::DebugStringObject& object, const ::zserio::ppmr::PropagatingPolymorphicAllocator<::std::uint8_t>& alloc = {}) :
                ::zserio::detail::ReflectableDataAllocatorHolderBase<::zserio::ppmr::PropagatingPolymorphicAllocator<::std::uint8_t>>(typeInfo<::test_object::ppmr_allocator::DebugStringObject>(), alloc),
                m_object(object)
        {}
...
::zserio::ppmr::IIntrospectableViewConstPtr Introspectable<::test_object::ppmr_allocator::DebugStringObject, ::zserio::ppmr::PropagatingPolymorphicAllocator<::std::uint8_t>>::create(
        const View<::test_object::ppmr_allocator::DebugStringObject>& view, const ::zserio::ppmr::PropagatingPolymorphicAllocator<::std::uint8_t>& allocator)
{
    class IntrospectableImpl : public ::zserio::detail::CompoundIntrospectableViewBase<::test_object::ppmr_allocator::DebugStringObject, ::zserio::ppmr::PropagatingPolymorphicAllocator<::std::uint8_t>>
    {
    public:
        explicit IntrospectableImpl(const ::zserio::View<::test_object::ppmr_allocator::DebugStringObject>& view_, const ::zserio::ppmr::PropagatingPolymorphicAllocator<::std::uint8_t>& alloc = {}) :
                ::zserio::detail::CompoundIntrospectableViewBase<::test_object::ppmr_allocator::DebugStringObject, ::zserio::ppmr::PropagatingPolymorphicAllocator<::std::uint8_t>>(
                        view_, alloc)
        {}
...
::std::size_t hash<::test_object::ppmr_allocator::DebugStringObject>::operator()(const ::test_object::ppmr_allocator::DebugStringObject& data) const
{
...
::std::size_t hash<::zserio::View<::test_object::ppmr_allocator::DebugStringObject>>::operator()(const ::zserio::View<::test_object::ppmr_allocator::DebugStringObject>& view) const
{
    ::std::uint32_t result = ::zserio::HASH_SEED;
