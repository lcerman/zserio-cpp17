    ...
    case 2:
        ...
        if (view.zserioChoiceTag() != ::test_object::ppmr_allocator::ReflectableUtilChoice::Tag::array)
        {
            throw ChoiceCaseException("Wrong case set in choice 'ReflectableUtilChoice' (") << static_cast<::std::size_t>(view.zserioChoiceTag()) <<
                    " != " << static_cast<::std::size_t>(::test_object::ppmr_allocator::ReflectableUtilChoice::Tag::array) << ")!";
        }
        detail::validate<ArrayType::AUTO>(view.array(), "'ReflectableUtilChoice.array'");
        break;
    default:
        // empty
        if (view.zserioChoiceTag() != ::test_object::ppmr_allocator::ReflectableUtilChoice::Tag::ZSERIO_UNDEFINED)
        {
...
const ::zserio::ppmr::ITypeInfo& TypeInfo<::test_object::ppmr_allocator::ReflectableUtilChoice, ::zserio::ppmr::PropagatingPolymorphicAllocator<::std::uint8_t>>::get()
{
...
::zserio::ppmr::IReflectableDataConstPtr Reflectable<::test_object::ppmr_allocator::ReflectableUtilChoice, ::zserio::ppmr::PropagatingPolymorphicAllocator<::std::uint8_t>>::create(
        const ::test_object::ppmr_allocator::ReflectableUtilChoice& value, const ::zserio::ppmr::PropagatingPolymorphicAllocator<::std::uint8_t>& allocator)
{
    ...
    public:
        ...
        explicit ReflectableImpl(const ::test_object::ppmr_allocator::ReflectableUtilChoice& object, const ::zserio::ppmr::PropagatingPolymorphicAllocator<::std::uint8_t>& alloc = {}) :
                ::zserio::detail::ReflectableDataConstAllocatorHolderBase<::zserio::ppmr::PropagatingPolymorphicAllocator<::std::uint8_t>>(typeInfo<::test_object::ppmr_allocator::ReflectableUtilChoice>(), alloc),
                m_object(object)
        {}
...
::zserio::ppmr::IReflectableDataPtr Reflectable<::test_object::ppmr_allocator::ReflectableUtilChoice, ::zserio::ppmr::PropagatingPolymorphicAllocator<::std::uint8_t>>::create(
        ::test_object::ppmr_allocator::ReflectableUtilChoice& value, const ::zserio::ppmr::PropagatingPolymorphicAllocator<::std::uint8_t>& allocator)
{
    ...
    public:
        ...
        explicit ReflectableImpl(::test_object::ppmr_allocator::ReflectableUtilChoice& object, const ::zserio::ppmr::PropagatingPolymorphicAllocator<::std::uint8_t>& alloc = {}) :
                ::zserio::detail::ReflectableDataAllocatorHolderBase<::zserio::ppmr::PropagatingPolymorphicAllocator<::std::uint8_t>>(typeInfo<::test_object::ppmr_allocator::ReflectableUtilChoice>(), alloc),
                m_object(object)
        {}
        ...
        void setField(::std::string_view name, const ::zserio::ppmr::Any& value) override
        {
            if (name == "array")
            {
                m_object.template emplace<::test_object::ppmr_allocator::ReflectableUtilChoice::Tag::array>(
...
::zserio::ppmr::IIntrospectableViewConstPtr Introspectable<::test_object::ppmr_allocator::ReflectableUtilChoice, ::zserio::ppmr::PropagatingPolymorphicAllocator<::std::uint8_t>>::create(
        const View<::test_object::ppmr_allocator::ReflectableUtilChoice>& view, const ::zserio::ppmr::PropagatingPolymorphicAllocator<::std::uint8_t>& allocator)
{
    class IntrospectableImpl : public ::zserio::detail::CompoundIntrospectableViewBase<::test_object::ppmr_allocator::ReflectableUtilChoice, ::zserio::ppmr::PropagatingPolymorphicAllocator<::std::uint8_t>>
    {
    public:
        explicit IntrospectableImpl(const ::zserio::View<::test_object::ppmr_allocator::ReflectableUtilChoice>& view_, const ::zserio::ppmr::PropagatingPolymorphicAllocator<::std::uint8_t>& alloc = {}) :
                ::zserio::detail::CompoundIntrospectableViewBase<::test_object::ppmr_allocator::ReflectableUtilChoice, ::zserio::ppmr::PropagatingPolymorphicAllocator<::std::uint8_t>>(
                        view_, alloc)
        {}
...
::std::size_t hash<::test_object::ppmr_allocator::ReflectableUtilChoice>::operator()(const ::test_object::ppmr_allocator::ReflectableUtilChoice& value) const
{
...
::std::size_t hash<::zserio::View<::test_object::ppmr_allocator::ReflectableUtilChoice>>::operator()(const ::zserio::View<::test_object::ppmr_allocator::ReflectableUtilChoice>& view) const
{
    ::std::uint32_t result = ::zserio::HASH_SEED;
