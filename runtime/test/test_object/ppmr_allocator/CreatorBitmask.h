...
template <>
struct TypeInfo<::test_object::ppmr_allocator::CreatorBitmask, ::zserio::ppmr::PropagatingPolymorphicAllocator<::std::uint8_t>>
{
...
{
    ::std::size_t operator()(const ::test_object::ppmr_allocator::CreatorBitmask& value) const;
};
