...
template <>
::std::size_t enumToOrdinal<::test_object::ppmr_allocator::ReflectableUtilEnum>(::test_object::ppmr_allocator::ReflectableUtilEnum value);
...
template <>
struct TypeInfo<::test_object::ppmr_allocator::ReflectableUtilEnum, ::zserio::ppmr::PropagatingPolymorphicAllocator<::std::uint8_t>>
{
...
{
    ::std::size_t operator()(const ::test_object::ppmr_allocator::ReflectableUtilEnum& value) const;
};
