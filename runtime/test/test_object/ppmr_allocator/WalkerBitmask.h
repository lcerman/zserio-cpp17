...
#ifndef TEST_OBJECT_PPMR_ALLOCATOR_WALKER_BITMASK_H
#define TEST_OBJECT_PPMR_ALLOCATOR_WALKER_BITMASK_H
...
template <>
struct TypeInfo<::test_object::ppmr_allocator::WalkerBitmask, ::zserio::ppmr::PropagatingPolymorphicAllocator<::std::uint8_t>>
{
...
template <>
struct hash<::test_object::ppmr_allocator::WalkerBitmask>
{
    ::std::size_t operator()(const ::test_object::ppmr_allocator::WalkerBitmask& value) const;
};

} // namespace std

#endif // TEST_OBJECT_PPMR_ALLOCATOR_WALKER_BITMASK_H
