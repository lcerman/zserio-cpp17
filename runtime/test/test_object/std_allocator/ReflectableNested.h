...
template <>
struct TypeInfo<::test_object::std_allocator::ReflectableNested, ::std::allocator<::std::uint8_t>>
{
    static const ::zserio::ITypeInfo& get();
};

template <>
struct Reflectable<::test_object::std_allocator::ReflectableNested, ::std::allocator<::std::uint8_t>>
{
...
template <>
struct Introspectable<::test_object::std_allocator::ReflectableNested, ::std::allocator<::std::uint8_t>>
{
...
{
    ::std::size_t operator()(const ::test_object::std_allocator::ReflectableNested& data) const;
};

template <>
struct hash<::zserio::View<::test_object::std_allocator::ReflectableNested>>
{
    ::std::size_t operator()(const ::zserio::View<::test_object::std_allocator::ReflectableNested>& view) const;
};
