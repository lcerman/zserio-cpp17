...
template <>
class View<::test_object::std_allocator::DebugStringParamObject>
{
public:
    explicit View(const ::test_object::std_allocator::DebugStringParamObject& data,
    ...
    const ::test_object::std_allocator::DebugStringParamObject& zserioData() const;

protected:
    View(const ::test_object::std_allocator::DebugStringParamObject& data, const View& other) noexcept;

private:
    const ::test_object::std_allocator::DebugStringParamObject* m_data;
...
template <>
struct ObjectTraits<::test_object::std_allocator::DebugStringParamObject>
{
    using Parameters = std::tuple<
            ::zserio::Int32>;

    static void validate(const View<::test_object::std_allocator::DebugStringParamObject>& view, ::std::string_view fieldName);

    static BitSize bitSizeOf(const View<::test_object::std_allocator::DebugStringParamObject>& view, BitSize bitPosition);

    static void write(BitStreamWriter& writer, const View<::test_object::std_allocator::DebugStringParamObject>& view);

    static View<::test_object::std_allocator::DebugStringParamObject> read(BitStreamReader& reader, ::test_object::std_allocator::DebugStringParamObject& data,
            ::zserio::Int32 param_);
};

template <>
struct TypeInfo<::test_object::std_allocator::DebugStringParamObject, ::std::allocator<::std::uint8_t>>
{
    static const ::zserio::ITypeInfo& get();
};

template <>
struct Reflectable<::test_object::std_allocator::DebugStringParamObject, ::std::allocator<::std::uint8_t>>
{
    static ::zserio::IReflectableDataConstPtr create(const ::test_object::std_allocator::DebugStringParamObject& value,
            const ::std::allocator<::std::uint8_t>& allocator);
...
template <>
struct Introspectable<::test_object::std_allocator::DebugStringParamObject, ::std::allocator<::std::uint8_t>>
{
...
template <>
struct hash<::test_object::std_allocator::DebugStringParamObject>
{
    ::std::size_t operator()(const ::test_object::std_allocator::DebugStringParamObject& data) const;
};

template <>
struct hash<::zserio::View<::test_object::std_allocator::DebugStringParamObject>>
{
    ::std::size_t operator()(const ::zserio::View<::test_object::std_allocator::DebugStringParamObject>& view) const;
};
