...
template <>
struct TypeInfo<::test_object::std_allocator::ReflectableObject, ::std::allocator<::std::uint8_t>>
{
    static const ::zserio::ITypeInfo& get();
};

template <>
struct Reflectable<::test_object::std_allocator::ReflectableObject, ::std::allocator<::std::uint8_t>>
{
    static ::zserio::IReflectableDataConstPtr create(const ::test_object::std_allocator::ReflectableObject& value,
            const ::std::allocator<::std::uint8_t>& allocator);

    static ::zserio::IReflectableDataPtr create(::test_object::std_allocator::ReflectableObject& value,
            const ::std::allocator<::std::uint8_t>& allocator);
};

template <>
struct Introspectable<::test_object::std_allocator::ReflectableObject, ::std::allocator<::std::uint8_t>>
{
    static ::zserio::IIntrospectableViewConstPtr create(const View<::test_object::std_allocator::ReflectableObject>& view,
            const ::std::allocator<::std::uint8_t>& allocator);
};
...
{
    ::std::size_t operator()(const ::test_object::std_allocator::ReflectableObject& data) const;
};

template <>
struct hash<::zserio::View<::test_object::std_allocator::ReflectableObject>>
{
    ::std::size_t operator()(const ::zserio::View<::test_object::std_allocator::ReflectableObject>& view) const;
};
