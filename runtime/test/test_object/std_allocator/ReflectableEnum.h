...
template <>
::std::size_t enumToOrdinal<::test_object::std_allocator::ReflectableEnum>(::test_object::std_allocator::ReflectableEnum value);
...
template <>
struct TypeInfo<::test_object::std_allocator::ReflectableEnum, ::std::allocator<::std::uint8_t>>
{
...
{
    ::std::size_t operator()(const ::test_object::std_allocator::ReflectableEnum& value) const;
};
