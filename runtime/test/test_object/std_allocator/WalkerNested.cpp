...
const ::zserio::ITypeInfo& TypeInfo<::test_object::std_allocator::WalkerNested, ::std::allocator<::std::uint8_t>>::get()
{
...
::zserio::IReflectableDataConstPtr Reflectable<::test_object::std_allocator::WalkerNested, ::std::allocator<::std::uint8_t>>::create(
        const ::test_object::std_allocator::WalkerNested& value, const ::std::allocator<::std::uint8_t>& allocator)
{
    ...
    public:
        ...
        explicit ReflectableImpl(const ::test_object::std_allocator::WalkerNested& object, const ::std::allocator<::std::uint8_t>& alloc = {}) :
                ::zserio::detail::ReflectableDataConstAllocatorHolderBase<::std::allocator<::std::uint8_t>>(typeInfo<::test_object::std_allocator::WalkerNested>(), alloc),
                m_object(object)
        {}
...
::zserio::IReflectableDataPtr Reflectable<::test_object::std_allocator::WalkerNested, ::std::allocator<::std::uint8_t>>::create(
        ::test_object::std_allocator::WalkerNested& value, const ::std::allocator<::std::uint8_t>& allocator)
{
    ...
    public:
        ...
        explicit ReflectableImpl(::test_object::std_allocator::WalkerNested& object, const ::std::allocator<::std::uint8_t>& alloc = {}) :
                ::zserio::detail::ReflectableDataAllocatorHolderBase<::std::allocator<::std::uint8_t>>(typeInfo<::test_object::std_allocator::WalkerNested>(), alloc),
                m_object(object)
        {}
...
::zserio::IIntrospectableViewConstPtr Introspectable<::test_object::std_allocator::WalkerNested, ::std::allocator<::std::uint8_t>>::create(
        const View<::test_object::std_allocator::WalkerNested>& view, const ::std::allocator<::std::uint8_t>& allocator)
{
    class IntrospectableImpl : public ::zserio::detail::CompoundIntrospectableViewBase<::test_object::std_allocator::WalkerNested, ::std::allocator<::std::uint8_t>>
    {
    public:
        explicit IntrospectableImpl(const ::zserio::View<::test_object::std_allocator::WalkerNested>& view_, const ::std::allocator<::std::uint8_t>& alloc = {}) :
                ::zserio::detail::CompoundIntrospectableViewBase<::test_object::std_allocator::WalkerNested, ::std::allocator<::std::uint8_t>>(
                        view_, alloc)
        {}
...
::std::size_t hash<::test_object::std_allocator::WalkerNested>::operator()(const ::test_object::std_allocator::WalkerNested& data) const
{
...
::std::size_t hash<::zserio::View<::test_object::std_allocator::WalkerNested>>::operator()(const ::zserio::View<::test_object::std_allocator::WalkerNested>& view) const
{
    ::std::uint32_t result = ::zserio::HASH_SEED;
