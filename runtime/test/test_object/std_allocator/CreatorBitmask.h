...
template <>
struct TypeInfo<::test_object::std_allocator::CreatorBitmask, ::std::allocator<::std::uint8_t>>
{
...
{
    ::std::size_t operator()(const ::test_object::std_allocator::CreatorBitmask& value) const;
};
