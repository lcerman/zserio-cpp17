...
template <>
::std::size_t enumToOrdinal<::test_object::std_allocator::CreatorEnum>(::test_object::std_allocator::CreatorEnum value);
...
template <>
struct TypeInfo<::test_object::std_allocator::CreatorEnum, ::std::allocator<::std::uint8_t>>
{
...
{
    ::std::size_t operator()(const ::test_object::std_allocator::CreatorEnum& value) const;
};
