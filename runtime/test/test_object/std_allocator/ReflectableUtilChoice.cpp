...
void ObjectTraits<::test_object::std_allocator::ReflectableUtilChoice>::validate(const View<::test_object::std_allocator::ReflectableUtilChoice>& view, ::std::string_view)
{
    ...
    case 2:
        ...
        if (view.zserioChoiceTag() != ::test_object::std_allocator::ReflectableUtilChoice::Tag::array)
        {
            throw ChoiceCaseException("Wrong case set in choice 'ReflectableUtilChoice' (") << static_cast<::std::size_t>(view.zserioChoiceTag()) <<
                    " != " << static_cast<::std::size_t>(::test_object::std_allocator::ReflectableUtilChoice::Tag::array) << ")!";
        }
...
BitSize ObjectTraits<::test_object::std_allocator::ReflectableUtilChoice>::bitSizeOf(const View<::test_object::std_allocator::ReflectableUtilChoice>& view, BitSize bitPosition)
{
...
void ObjectTraits<::test_object::std_allocator::ReflectableUtilChoice>::write(BitStreamWriter& writer, const View<::test_object::std_allocator::ReflectableUtilChoice>& view)
{
    switch (view.zserioChoiceTag())
    {
    case ::test_object::std_allocator::ReflectableUtilChoice::Tag::array:
...
View<::test_object::std_allocator::ReflectableUtilChoice> ObjectTraits<::test_object::std_allocator::ReflectableUtilChoice>::read(BitStreamReader& reader, ::test_object::std_allocator::ReflectableUtilChoice& data,
        ::zserio::UInt8 param_)
{
    ...
    case 2:
        ...
        detail::read<ArrayType::AUTO>(reader, data.get<::test_object::std_allocator::ReflectableUtilChoice::Tag::array>());
        break;
    default:
        // empty
        break;
...
const ::zserio::ITypeInfo& TypeInfo<::test_object::std_allocator::ReflectableUtilChoice, ::std::allocator<::std::uint8_t>>::get()
{
    ...
    static const ::zserio::detail::ChoiceTypeInfo<AllocatorType> typeInfo = {
        ...
        {
            return ::std::allocate_shared<::zserio::detail::ReflectableDataOwner<::test_object::std_allocator::ReflectableUtilChoice>>(allocator);
        },
...
::zserio::IReflectableDataConstPtr Reflectable<::test_object::std_allocator::ReflectableUtilChoice, ::std::allocator<::std::uint8_t>>::create(
        const ::test_object::std_allocator::ReflectableUtilChoice& value, const ::std::allocator<::std::uint8_t>& allocator)
{
    ...
    public:
        ...
        explicit ReflectableImpl(const ::test_object::std_allocator::ReflectableUtilChoice& object, const ::std::allocator<::std::uint8_t>& alloc = {}) :
                ::zserio::detail::ReflectableDataConstAllocatorHolderBase<::std::allocator<::std::uint8_t>>(typeInfo<::test_object::std_allocator::ReflectableUtilChoice>(), alloc),
                m_object(object)
        {}
...
::zserio::IReflectableDataPtr Reflectable<::test_object::std_allocator::ReflectableUtilChoice, ::std::allocator<::std::uint8_t>>::create(
        ::test_object::std_allocator::ReflectableUtilChoice& value, const ::std::allocator<::std::uint8_t>& allocator)
{
    ...
    public:
        ...
        explicit ReflectableImpl(::test_object::std_allocator::ReflectableUtilChoice& object, const ::std::allocator<::std::uint8_t>& alloc = {}) :
                ::zserio::detail::ReflectableDataAllocatorHolderBase<::std::allocator<::std::uint8_t>>(typeInfo<::test_object::std_allocator::ReflectableUtilChoice>(), alloc),
                m_object(object)
        {}
        ...
        void setField(::std::string_view name, const ::zserio::Any& value) override
        {
            if (name == "array")
            {
                m_object.template emplace<::test_object::std_allocator::ReflectableUtilChoice::Tag::array>(
...
::zserio::IIntrospectableViewConstPtr Introspectable<::test_object::std_allocator::ReflectableUtilChoice, ::std::allocator<::std::uint8_t>>::create(
        const View<::test_object::std_allocator::ReflectableUtilChoice>& view, const ::std::allocator<::std::uint8_t>& allocator)
{
    class IntrospectableImpl : public ::zserio::detail::CompoundIntrospectableViewBase<::test_object::std_allocator::ReflectableUtilChoice, ::std::allocator<::std::uint8_t>>
    {
    public:
        explicit IntrospectableImpl(const ::zserio::View<::test_object::std_allocator::ReflectableUtilChoice>& view_, const ::std::allocator<::std::uint8_t>& alloc = {}) :
                ::zserio::detail::CompoundIntrospectableViewBase<::test_object::std_allocator::ReflectableUtilChoice, ::std::allocator<::std::uint8_t>>(
                        view_, alloc)
        {}
...
::std::size_t hash<::test_object::std_allocator::ReflectableUtilChoice>::operator()(const ::test_object::std_allocator::ReflectableUtilChoice& value) const
{
...
::std::size_t hash<::zserio::View<::test_object::std_allocator::ReflectableUtilChoice>>::operator()(const ::zserio::View<::test_object::std_allocator::ReflectableUtilChoice>& view) const
{
    ::std::uint32_t result = ::zserio::HASH_SEED;
