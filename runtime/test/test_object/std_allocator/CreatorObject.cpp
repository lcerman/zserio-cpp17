...
View<::test_object::std_allocator::CreatorNested> View<::test_object::std_allocator::CreatorObject>::ZserioNestedArrayArrayTraits::at(const OwnerType& owner,
        const ::test_object::std_allocator::CreatorNested& element, ::std::size_t)
{
    return View<::test_object::std_allocator::CreatorNested>(element, detail::makeParameter<0, ::test_object::std_allocator::CreatorNested>(owner.value()));
}
...
void View<::test_object::std_allocator::CreatorObject>::ZserioNestedArrayArrayTraits::read(BitStreamReader& reader, const OwnerType& owner,
        ::test_object::std_allocator::CreatorNested& element, ::std::size_t)
{
    (void)detail::read(reader, element, detail::makeParameter<0, ::test_object::std_allocator::CreatorNested>(owner.value()));
}
...
void ObjectTraits<::test_object::std_allocator::CreatorObject>::validate(const View<::test_object::std_allocator::CreatorObject>& view, ::std::string_view)
{
...
BitSize ObjectTraits<::test_object::std_allocator::CreatorObject>::bitSizeOf(const View<::test_object::std_allocator::CreatorObject>& view, BitSize bitPosition)
{
...
void ObjectTraits<::test_object::std_allocator::CreatorObject>::write(BitStreamWriter& writer, const View<::test_object::std_allocator::CreatorObject>& view)
{
    auto value_ = view.value();
...
View<::test_object::std_allocator::CreatorObject> ObjectTraits<::test_object::std_allocator::CreatorObject>::read(BitStreamReader& reader, ::test_object::std_allocator::CreatorObject& data)
{
    ...
    if (reader.readBool())
    {
        ...
        (void)detail::read(reader, *data.optionalNested, detail::makeParameter<0, ::test_object::std_allocator::CreatorNested>(view.value()));
    }
    else
    {
...
const ::zserio::ITypeInfo& TypeInfo<::test_object::std_allocator::CreatorObject, ::std::allocator<::std::uint8_t>>::get()
{
    ...
    static const ::std::array<::zserio::BasicFieldInfo<AllocatorType>, 9> fields = {
        ...
        ::zserio::BasicFieldInfo<AllocatorType>{
            "nested", // schemaName
            ::zserio::typeInfo<::test_object::std_allocator::CreatorNested, ::std::allocator<::std::uint8_t>>(), // typeInfo
        ...
        ::zserio::BasicFieldInfo<AllocatorType>{
            ...
            ::zserio::typeInfo<::zserio::BitBuffer, ::std::allocator<::std::uint8_t>>(), // typeInfo
            {}, // typeArguments
            false, // isExtended
            {}, // alignment
            {}, // offset
        ...
        ::zserio::BasicFieldInfo<AllocatorType>{
            ...
            ::zserio::typeInfo<::zserio::Bytes, ::std::allocator<::std::uint8_t>>(), // typeInfo
            {}, // typeArguments
            false, // isExtended
            {}, // alignment
            {}, // offset
        ...
        ::zserio::BasicFieldInfo<AllocatorType>{
            ...
            ::zserio::typeInfo<::zserio::Bool, ::std::allocator<::std::uint8_t>>(), // typeInfo
            {}, // typeArguments
            false, // isExtended
            {}, // alignment
            {}, // offset
...
::zserio::IReflectableDataConstPtr Reflectable<::test_object::std_allocator::CreatorObject, ::std::allocator<::std::uint8_t>>::create(
        const ::test_object::std_allocator::CreatorObject& value, const ::std::allocator<::std::uint8_t>& allocator)
{
    ...
    public:
        ...
        explicit ReflectableImpl(const ::test_object::std_allocator::CreatorObject& object, const ::std::allocator<::std::uint8_t>& alloc = {}) :
                ::zserio::detail::ReflectableDataConstAllocatorHolderBase<::std::allocator<::std::uint8_t>>(typeInfo<::test_object::std_allocator::CreatorObject>(), alloc),
                m_object(object)
        {}
...
::zserio::IReflectableDataPtr Reflectable<::test_object::std_allocator::CreatorObject, ::std::allocator<::std::uint8_t>>::create(
        ::test_object::std_allocator::CreatorObject& value, const ::std::allocator<::std::uint8_t>& allocator)
{
    ...
    public:
        ...
        explicit ReflectableImpl(::test_object::std_allocator::CreatorObject& object, const ::std::allocator<::std::uint8_t>& alloc = {}) :
                ::zserio::detail::ReflectableDataAllocatorHolderBase<::std::allocator<::std::uint8_t>>(typeInfo<::test_object::std_allocator::CreatorObject>(), alloc),
                m_object(object)
        {}
...
::zserio::IIntrospectableViewConstPtr Introspectable<::test_object::std_allocator::CreatorObject, ::std::allocator<::std::uint8_t>>::create(
        const View<::test_object::std_allocator::CreatorObject>& view, const ::std::allocator<::std::uint8_t>& allocator)
{
    class IntrospectableImpl : public ::zserio::detail::CompoundIntrospectableViewBase<::test_object::std_allocator::CreatorObject, ::std::allocator<::std::uint8_t>>
    {
    public:
        explicit IntrospectableImpl(const ::zserio::View<::test_object::std_allocator::CreatorObject>& view_, const ::std::allocator<::std::uint8_t>& alloc = {}) :
                ::zserio::detail::CompoundIntrospectableViewBase<::test_object::std_allocator::CreatorObject, ::std::allocator<::std::uint8_t>>(
                        view_, alloc)
        {}
...
::std::size_t hash<::test_object::std_allocator::CreatorObject>::operator()(const ::test_object::std_allocator::CreatorObject& data) const
{
...
::std::size_t hash<::zserio::View<::test_object::std_allocator::CreatorObject>>::operator()(const ::zserio::View<::test_object::std_allocator::CreatorObject>& view) const
{
    ::std::uint32_t result = ::zserio::HASH_SEED;
