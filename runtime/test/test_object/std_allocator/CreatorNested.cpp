...
void ObjectTraits<::test_object::std_allocator::CreatorNested>::validate(const View<::test_object::std_allocator::CreatorNested>& view, ::std::string_view)
{
...
BitSize ObjectTraits<::test_object::std_allocator::CreatorNested>::bitSizeOf(const View<::test_object::std_allocator::CreatorNested>& view, BitSize bitPosition)
{
...
void ObjectTraits<::test_object::std_allocator::CreatorNested>::write(BitStreamWriter& writer, const View<::test_object::std_allocator::CreatorNested>& view)
{
    auto value_ = view.value();
...
View<::test_object::std_allocator::CreatorNested> ObjectTraits<::test_object::std_allocator::CreatorNested>::read(BitStreamReader& reader, ::test_object::std_allocator::CreatorNested& data,
...
const ::zserio::ITypeInfo& TypeInfo<::test_object::std_allocator::CreatorNested, ::std::allocator<::std::uint8_t>>::get()
{
    ...
    static const ::std::array<::zserio::BasicFieldInfo<AllocatorType>, 6> fields = {
        ...
        ::zserio::BasicFieldInfo<AllocatorType>{
            ...
            ::zserio::typeInfo<::test_object::std_allocator::CreatorEnum, ::std::allocator<::std::uint8_t>>(), // typeInfo
            {}, // typeArguments
            false, // isExtended
            {}, // alignment
            {}, // offset
        ...
        ::zserio::BasicFieldInfo<AllocatorType>{
            ...
            ::zserio::typeInfo<::test_object::std_allocator::CreatorBitmask, ::std::allocator<::std::uint8_t>>(), // typeInfo
            {}, // typeArguments
            false, // isExtended
            {}, // alignment
            {}, // offset
    ...
    static const ::std::array<::zserio::BasicParameterInfo<AllocatorType>, 1> parameters = {
        ::zserio::BasicParameterInfo<AllocatorType>{
            "param",
            ::zserio::typeInfo<::zserio::UInt32, ::std::allocator<::std::uint8_t>>()
        }
    };
...
::zserio::IReflectableDataConstPtr Reflectable<::test_object::std_allocator::CreatorNested, ::std::allocator<::std::uint8_t>>::create(
        const ::test_object::std_allocator::CreatorNested& value, const ::std::allocator<::std::uint8_t>& allocator)
{
    ...
    public:
        ...
        explicit ReflectableImpl(const ::test_object::std_allocator::CreatorNested& object, const ::std::allocator<::std::uint8_t>& alloc = {}) :
                ::zserio::detail::ReflectableDataConstAllocatorHolderBase<::std::allocator<::std::uint8_t>>(typeInfo<::test_object::std_allocator::CreatorNested>(), alloc),
                m_object(object)
        {}
...
::zserio::IReflectableDataPtr Reflectable<::test_object::std_allocator::CreatorNested, ::std::allocator<::std::uint8_t>>::create(
        ::test_object::std_allocator::CreatorNested& value, const ::std::allocator<::std::uint8_t>& allocator)
{
    ...
    public:
        ...
        explicit ReflectableImpl(::test_object::std_allocator::CreatorNested& object, const ::std::allocator<::std::uint8_t>& alloc = {}) :
                ::zserio::detail::ReflectableDataAllocatorHolderBase<::std::allocator<::std::uint8_t>>(typeInfo<::test_object::std_allocator::CreatorNested>(), alloc),
                m_object(object)
        {}
...
::zserio::IIntrospectableViewConstPtr Introspectable<::test_object::std_allocator::CreatorNested, ::std::allocator<::std::uint8_t>>::create(
        const View<::test_object::std_allocator::CreatorNested>& view, const ::std::allocator<::std::uint8_t>& allocator)
{
    class IntrospectableImpl : public ::zserio::detail::CompoundIntrospectableViewBase<::test_object::std_allocator::CreatorNested, ::std::allocator<::std::uint8_t>>
    {
    public:
        explicit IntrospectableImpl(const ::zserio::View<::test_object::std_allocator::CreatorNested>& view_, const ::std::allocator<::std::uint8_t>& alloc = {}) :
                ::zserio::detail::CompoundIntrospectableViewBase<::test_object::std_allocator::CreatorNested, ::std::allocator<::std::uint8_t>>(
                        view_, alloc)
        {}
...
::std::size_t hash<::test_object::std_allocator::CreatorNested>::operator()(const ::test_object::std_allocator::CreatorNested& data) const
{
...
::std::size_t hash<::zserio::View<::test_object::std_allocator::CreatorNested>>::operator()(const ::zserio::View<::test_object::std_allocator::CreatorNested>& view) const
{
    ::std::uint32_t result = ::zserio::HASH_SEED;
