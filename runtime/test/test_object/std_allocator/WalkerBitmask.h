...
template <>
struct TypeInfo<::test_object::std_allocator::WalkerBitmask, ::std::allocator<::std::uint8_t>>
{
...
{
    ::std::size_t operator()(const ::test_object::std_allocator::WalkerBitmask& value) const;
};
