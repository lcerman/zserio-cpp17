...
const ::zserio::ITypeInfo& TypeInfo<::test_object::std_allocator::ReflectableNested, ::std::allocator<::std::uint8_t>>::get()
{
    ...
    static const ::std::array<::zserio::BasicFieldInfo<AllocatorType>, 1> fields = {
        ::zserio::BasicFieldInfo<AllocatorType>{
            "value", // schemaName
            ::zserio::typeInfo<::zserio::UInt31, ::std::allocator<::std::uint8_t>>(), // typeInfo
            {}, // typeArguments
            false, // isExtended
            {}, // alignment
            {}, // offset
    ...
    static const ::std::array<::zserio::BasicParameterInfo<AllocatorType>, 2> parameters = {
        ::zserio::BasicParameterInfo<AllocatorType>{
            "dummyParam",
            ::zserio::typeInfo<::zserio::Int31, ::std::allocator<::std::uint8_t>>()
        },
        ::zserio::BasicParameterInfo<AllocatorType>{
            "stringParam",
            ::zserio::typeInfo<::zserio::String, ::std::allocator<::std::uint8_t>>()
        }
    };
    ...
    static const ::std::array<::zserio::BasicFunctionInfo<AllocatorType>, 1> functions = {
        ::zserio::BasicFunctionInfo<AllocatorType>{
            "getValue",
            ::zserio::typeInfo<::zserio::UInt31, ::std::allocator<::std::uint8_t>>(),
            "value()"
        }
    };
    ...
    static const ::zserio::detail::StructTypeInfo<AllocatorType> typeInfo = {
        ...
        {
            return ::std::allocate_shared<::zserio::detail::ReflectableDataOwner<::test_object::std_allocator::ReflectableNested>>(allocator);
        },
...
::zserio::IReflectableDataConstPtr Reflectable<::test_object::std_allocator::ReflectableNested, ::std::allocator<::std::uint8_t>>::create(
        const ::test_object::std_allocator::ReflectableNested& value, const ::std::allocator<::std::uint8_t>& allocator)
{
    ...
    public:
        ...
        explicit ReflectableImpl(const ::test_object::std_allocator::ReflectableNested& object, const ::std::allocator<::std::uint8_t>& alloc = {}) :
                ::zserio::detail::ReflectableDataConstAllocatorHolderBase<::std::allocator<::std::uint8_t>>(typeInfo<::test_object::std_allocator::ReflectableNested>(), alloc),
                m_object(object)
        {}
...
::zserio::IReflectableDataPtr Reflectable<::test_object::std_allocator::ReflectableNested, ::std::allocator<::std::uint8_t>>::create(
        ::test_object::std_allocator::ReflectableNested& value, const ::std::allocator<::std::uint8_t>& allocator)
{
    ...
    public:
        ...
        explicit ReflectableImpl(::test_object::std_allocator::ReflectableNested& object, const ::std::allocator<::std::uint8_t>& alloc = {}) :
                ::zserio::detail::ReflectableDataAllocatorHolderBase<::std::allocator<::std::uint8_t>>(typeInfo<::test_object::std_allocator::ReflectableNested>(), alloc),
                m_object(object)
        {}
...
::zserio::IIntrospectableViewConstPtr Introspectable<::test_object::std_allocator::ReflectableNested, ::std::allocator<::std::uint8_t>>::create(
        const View<::test_object::std_allocator::ReflectableNested>& view, const ::std::allocator<::std::uint8_t>& allocator)
{
    class IntrospectableImpl : public ::zserio::detail::CompoundIntrospectableViewBase<::test_object::std_allocator::ReflectableNested, ::std::allocator<::std::uint8_t>>
    {
    public:
        explicit IntrospectableImpl(const ::zserio::View<::test_object::std_allocator::ReflectableNested>& view_, const ::std::allocator<::std::uint8_t>& alloc = {}) :
                ::zserio::detail::CompoundIntrospectableViewBase<::test_object::std_allocator::ReflectableNested, ::std::allocator<::std::uint8_t>>(
                        view_, alloc)
        {}
...
::std::size_t hash<::test_object::std_allocator::ReflectableNested>::operator()(const ::test_object::std_allocator::ReflectableNested& data) const
{
...
::std::size_t hash<::zserio::View<::test_object::std_allocator::ReflectableNested>>::operator()(const ::zserio::View<::test_object::std_allocator::ReflectableNested>& view) const
{
    ::std::uint32_t result = ::zserio::HASH_SEED;
