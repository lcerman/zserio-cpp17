...
template <>
::std::size_t enumToOrdinal<::test_object::std_allocator::ReflectableUtilEnum>(::test_object::std_allocator::ReflectableUtilEnum value);
...
template <>
struct TypeInfo<::test_object::std_allocator::ReflectableUtilEnum, ::std::allocator<::std::uint8_t>>
{
...
{
    ::std::size_t operator()(const ::test_object::std_allocator::ReflectableUtilEnum& value) const;
};
