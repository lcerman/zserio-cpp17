...
{
    return get<::test_object::std_allocator::WalkerChoice::Tag::value8>(*m_data);
}

::zserio::UInt16 View<::test_object::std_allocator::WalkerChoice>::value16() const
{
    return get<::test_object::std_allocator::WalkerChoice::Tag::value16>(*m_data);
}

::zserio::UInt32 View<::test_object::std_allocator::WalkerChoice>::value32() const
{
    return get<::test_object::std_allocator::WalkerChoice::Tag::value32>(*m_data);
}

::zserio::UInt64 View<::test_object::std_allocator::WalkerChoice>::value64() const
{
    return get<::test_object::std_allocator::WalkerChoice::Tag::value64>(*m_data);
}

::test_object::std_allocator::WalkerChoice::Tag View<::test_object::std_allocator::WalkerChoice>::zserioChoiceTag() const
{
    return m_data->index();
}
...
void ObjectTraits<::test_object::std_allocator::WalkerChoice>::validate(const View<::test_object::std_allocator::WalkerChoice>& view, ::std::string_view)
{
    ...
    case 8:
        // check choice case
        if (view.zserioChoiceTag() != ::test_object::std_allocator::WalkerChoice::Tag::value8)
        {
            throw ChoiceCaseException("Wrong case set in choice 'WalkerChoice' (") << static_cast<::std::size_t>(view.zserioChoiceTag()) <<
                    " != " << static_cast<::std::size_t>(::test_object::std_allocator::WalkerChoice::Tag::value8) << ")!";
        }
        detail::validate(view.value8(), "'WalkerChoice.value8'");
        break;
    case 16:
        // check choice case
        if (view.zserioChoiceTag() != ::test_object::std_allocator::WalkerChoice::Tag::value16)
        {
            throw ChoiceCaseException("Wrong case set in choice 'WalkerChoice' (") << static_cast<::std::size_t>(view.zserioChoiceTag()) <<
                    " != " << static_cast<::std::size_t>(::test_object::std_allocator::WalkerChoice::Tag::value16) << ")!";
        }
        detail::validate(view.value16(), "'WalkerChoice.value16'");
        break;
    case 32:
        // check choice case
        if (view.zserioChoiceTag() != ::test_object::std_allocator::WalkerChoice::Tag::value32)
        {
            throw ChoiceCaseException("Wrong case set in choice 'WalkerChoice' (") << static_cast<::std::size_t>(view.zserioChoiceTag()) <<
                    " != " << static_cast<::std::size_t>(::test_object::std_allocator::WalkerChoice::Tag::value32) << ")!";
        }
        detail::validate(view.value32(), "'WalkerChoice.value32'");
        break;
    case 64:
        // check choice case
        if (view.zserioChoiceTag() != ::test_object::std_allocator::WalkerChoice::Tag::value64)
        {
            throw ChoiceCaseException("Wrong case set in choice 'WalkerChoice' (") << static_cast<::std::size_t>(view.zserioChoiceTag()) <<
                    " != " << static_cast<::std::size_t>(::test_object::std_allocator::WalkerChoice::Tag::value64) << ")!";
        }
...
const ::zserio::ITypeInfo& TypeInfo<::test_object::std_allocator::WalkerChoice, ::std::allocator<::std::uint8_t>>::get()
{
    ...
    static const ::std::array<::zserio::BasicFieldInfo<AllocatorType>, 4> fields = {
        ::zserio::BasicFieldInfo<AllocatorType>{
            "value8", // schemaName
            ::zserio::typeInfo<::zserio::UInt8, ::std::allocator<::std::uint8_t>>(), // typeInfo
            {}, // typeArguments
            false, // isExtended
            {}, // alignment
            {}, // offset
        ...
        ::zserio::BasicFieldInfo<AllocatorType>{
            "value16", // schemaName
            ::zserio::typeInfo<::zserio::UInt16, ::std::allocator<::std::uint8_t>>(), // typeInfo
            {}, // typeArguments
            false, // isExtended
            {}, // alignment
            {}, // offset
        ...
        ::zserio::BasicFieldInfo<AllocatorType>{
            "value64", // schemaName
            ::zserio::typeInfo<::zserio::UInt64, ::std::allocator<::std::uint8_t>>(), // typeInfo
            {}, // typeArguments
            false, // isExtended
            {}, // alignment
            {}, // offset
    ...
    static const ::std::array<::zserio::BasicParameterInfo<AllocatorType>, 1> parameters = {
        ::zserio::BasicParameterInfo<AllocatorType>{
            "selector",
            ::zserio::typeInfo<::zserio::UInt8, ::std::allocator<::std::uint8_t>>()
        }
    };
...
::zserio::IReflectableDataConstPtr Reflectable<::test_object::std_allocator::WalkerChoice, ::std::allocator<::std::uint8_t>>::create(
        const ::test_object::std_allocator::WalkerChoice& value, const ::std::allocator<::std::uint8_t>& allocator)
{
    ...
    public:
        ...
        explicit ReflectableImpl(const ::test_object::std_allocator::WalkerChoice& object, const ::std::allocator<::std::uint8_t>& alloc = {}) :
                ::zserio::detail::ReflectableDataConstAllocatorHolderBase<::std::allocator<::std::uint8_t>>(typeInfo<::test_object::std_allocator::WalkerChoice>(), alloc),
                m_object(object)
        {}
        ...
        ::zserio::IReflectableDataConstPtr getField(::std::string_view name) const override
        {
            if (name == "value8")
            {
                return ::zserio::reflectable(
                        get<::test_object::std_allocator::WalkerChoice::Tag::value8>(m_object), get_allocator());
            }
            if (name == "value16")
            {
                return ::zserio::reflectable(
                        get<::test_object::std_allocator::WalkerChoice::Tag::value16>(m_object), get_allocator());
            }
            if (name == "value32")
            {
                return ::zserio::reflectable(
                        get<::test_object::std_allocator::WalkerChoice::Tag::value32>(m_object), get_allocator());
            }
            if (name == "value64")
            {
                return ::zserio::reflectable(
                        get<::test_object::std_allocator::WalkerChoice::Tag::value64>(m_object), get_allocator());
            }
...
::zserio::IReflectableDataPtr Reflectable<::test_object::std_allocator::WalkerChoice, ::std::allocator<::std::uint8_t>>::create(
        ::test_object::std_allocator::WalkerChoice& value, const ::std::allocator<::std::uint8_t>& allocator)
{
    ...
    public:
        ...
        explicit ReflectableImpl(::test_object::std_allocator::WalkerChoice& object, const ::std::allocator<::std::uint8_t>& alloc = {}) :
                ::zserio::detail::ReflectableDataAllocatorHolderBase<::std::allocator<::std::uint8_t>>(typeInfo<::test_object::std_allocator::WalkerChoice>(), alloc),
                m_object(object)
        {}
        ...
        void setField(::std::string_view name, const ::zserio::Any& value) override
        {
            if (name == "value8")
            {
                m_object.template emplace<::test_object::std_allocator::WalkerChoice::Tag::value8>(
                        ::zserio::ReflectableUtil::fromAny<::zserio::UInt8>(value));
                return;
            }
            if (name == "value16")
            {
                m_object.template emplace<::test_object::std_allocator::WalkerChoice::Tag::value16>(
                        ::zserio::ReflectableUtil::fromAny<::zserio::UInt16>(value));
                return;
            }
            if (name == "value32")
            {
                m_object.template emplace<::test_object::std_allocator::WalkerChoice::Tag::value32>(
                        ::zserio::ReflectableUtil::fromAny<::zserio::UInt32>(value));
                return;
            }
            if (name == "value64")
            {
                m_object.template emplace<::test_object::std_allocator::WalkerChoice::Tag::value64>(
        ...
        ::zserio::IReflectableDataPtr createField(::std::string_view name) override
        {
            ...
            {
                m_object.template emplace<::test_object::std_allocator::WalkerChoice::Tag::value8>();
                return ::zserio::reflectable(get<::test_object::std_allocator::WalkerChoice::Tag::value8>(m_object), get_allocator());
            }
            if (name == "value16")
            {
                m_object.template emplace<::test_object::std_allocator::WalkerChoice::Tag::value16>();
                return ::zserio::reflectable(get<::test_object::std_allocator::WalkerChoice::Tag::value16>(m_object), get_allocator());
            }
            if (name == "value32")
            {
                m_object.template emplace<::test_object::std_allocator::WalkerChoice::Tag::value32>();
                return ::zserio::reflectable(get<::test_object::std_allocator::WalkerChoice::Tag::value32>(m_object), get_allocator());
            }
            if (name == "value64")
            {
                m_object.template emplace<::test_object::std_allocator::WalkerChoice::Tag::value64>();
                return ::zserio::reflectable(get<::test_object::std_allocator::WalkerChoice::Tag::value64>(m_object), get_allocator());
            }
            throw ::zserio::CppRuntimeException("Field '") << name << "' doesn't exist in 'WalkerChoice'!";
        }
...
::zserio::IIntrospectableViewConstPtr Introspectable<::test_object::std_allocator::WalkerChoice, ::std::allocator<::std::uint8_t>>::create(
        const View<::test_object::std_allocator::WalkerChoice>& view, const ::std::allocator<::std::uint8_t>& allocator)
{
    class IntrospectableImpl : public ::zserio::detail::CompoundIntrospectableViewBase<::test_object::std_allocator::WalkerChoice, ::std::allocator<::std::uint8_t>>
    {
    public:
        explicit IntrospectableImpl(const ::zserio::View<::test_object::std_allocator::WalkerChoice>& view_, const ::std::allocator<::std::uint8_t>& alloc = {}) :
                ::zserio::detail::CompoundIntrospectableViewBase<::test_object::std_allocator::WalkerChoice, ::std::allocator<::std::uint8_t>>(
                        view_, alloc)
        {}
...
::std::size_t hash<::test_object::std_allocator::WalkerChoice>::operator()(const ::test_object::std_allocator::WalkerChoice& value) const
{
...
::std::size_t hash<::zserio::View<::test_object::std_allocator::WalkerChoice>>::operator()(const ::zserio::View<::test_object::std_allocator::WalkerChoice>& view) const
{
    ::std::uint32_t result = ::zserio::HASH_SEED;
