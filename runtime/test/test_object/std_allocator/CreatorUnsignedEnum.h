...
template <>
::std::size_t enumToOrdinal<::test_object::std_allocator::CreatorUnsignedEnum>(::test_object::std_allocator::CreatorUnsignedEnum value);
...
template <>
struct TypeInfo<::test_object::std_allocator::CreatorUnsignedEnum, ::std::allocator<::std::uint8_t>>
{
...
{
    ::std::size_t operator()(const ::test_object::std_allocator::CreatorUnsignedEnum& value) const;
};
